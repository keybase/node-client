...
(function() {
  var BaseScraper, BearerToken, Lock, TwitterScraper, bearer_token, constants, decode, iced, make_ids, sncmp, urlmod, v_codes, ws_normalize, __iced_k, __iced_k_noop, _bearer_token, _ref,
        ...
        return function() {
          ...
          if (rc !== v_codes.OK) {
            ...
            for (i = _i = 0, _len = json.length; _i < _len; i = ++_i) {
              _ref1 = json[i], text = _ref1.text, id_str = _ref1.id_str;
