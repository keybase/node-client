...
_break()
    ...
    DnsScraper.prototype._check_status = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          rc = typeof err !== "undefined" && err !== null ? (_this.log("| DNS error: " + err), v_codes.DNS_ERROR) : (__indexOf.call(records, proof_text_check) >= 0) ? v_codes.OK : (_this.log("| DNS failed; found TXT entries: " + (JSON.stringify(records))), v_codes.NOT_FOUND);
