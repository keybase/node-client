  ...
  BaseScraper = (function() {
    ...
    BaseScraper.prototype._get_url_body = function(opts, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          rc = typeof err !== "undefined" && err !== null ? err.code === 'ETIMEDOUT' ? v_codes.TIMEOUT : v_codes.HOST_UNREACHABLE : response.statusCode === 200 ? v_codes.OK : response.statusCode >= 500 ? v_codes.HTTP_500 : response.statusCode >= 400 ? v_codes.HTTP_400 : response.statusCode >= 300 ? v_codes.HTTP_300 : v_codes.HTTP_OTHER;
