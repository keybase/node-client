...
(function() {
  var Base, GenericBinding, SHA256, Verifier, WordArray, add_ids, akatch, base64_extract, base64u, bufeq_secure, cieq, constants, hash_sig, iced, json_stringify_sorted, katch, kbpgp, make_esc, make_ids, pgp_utils, proof_text_check_to_med_id, proof_type_to_string, sig_id_to_med_id, sig_id_to_short_id, streq_secure, triplesec, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1,
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/jacko/keybase-proofs/src/base.iced",
  ...
  Base = (function() {
    ...
    Base.prototype._json = function(_arg) {
      var ctime, ekid, expire_in, fp, ret;
      ...
      ret = {
        ...
        expire_in: expire_in || this.expire_in || constants.expire_in,
        body: {
