...
(function() {
  var Announcement, Auth, Cryptocurrency, Revoke, Track, Untrack, alloc, base, get_klass, web_service, _ref;
  ...
  get_klass = function(type) {
    ...
    klass = (function() {
      switch (type) {
        ...
        case "web_service_binding.reddit":
          return web_service.RedditBinding;
