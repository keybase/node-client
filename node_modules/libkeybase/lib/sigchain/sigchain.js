...
(function() {
  var ChainLink, E, KeyState, ParsedKeys, SIG_ID_SUFFIX, SigChain, UID_LEN, a_json_parse, athrow, bad_hash_trimmed_body, bad_whitespace_sig_ids, bufeq_secure, check_buffers_equal, check_link_payload_format, current_time_seconds, error_names, errors_map, iced, ie, kbpgp, make_esc, name, proofs, trim, __iced_k, __iced_k_noop, _i, _len, _ref;
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    if (bad_whitespace_sig_ids[sig_id] && ((sig_blob.payload_json + "\n") === verified_buffer.toString())) {
