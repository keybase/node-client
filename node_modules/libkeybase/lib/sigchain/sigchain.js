...
(function() {
  var ChainLink, E, ParsedKeys, SIG_ID_SUFFIX, SigChain, UID_LEN, a_json_parse, athrow, check_link_payload_format, current_time_seconds, error_names, errors_map, iced, ie, kbpgp, make_esc, name, proofs, __iced_k, __iced_k_noop, _i, _len, _ref;
          ...
          _while = function(__iced_k) {
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                ...
                return _next(fingerprint != null ? (fingerprint_str = fingerprint.toString("hex"), pgp_to_kid[fingerprint_str] = kid_str, kid_to_pgp[kid_str] = fingerprint_str) : void 0);
              });
            }
          };
          _while(__iced_k);
  ...
  ChainLink = (function() {
    ...
    ChainLink._unbox_payload = function(_arg, cb) {
      var ctime_seconds, did_unbox, err, esc, key_manager, kid, parsed_keys, payload, payload_buffer, payload_hash, payload_json, sig_blob, sig_body, sig_cache, sig_eng, sig_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sig_blob = _arg.sig_blob, parsed_keys = _arg.parsed_keys, sig_cache = _arg.sig_cache;
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                if (typeof payload_buffer === "undefined" || payload_buffer === null) {
                  did_unbox = true;
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
    ...
    ChainLink._check_payload_against_blob = function(_arg, cb) {
      var err, parsed_keys, payload, payload_ctime, payload_fingerprint, payload_kid, sig_blob, signing_ctime, signing_kid;
  ...
  exports.SigChain = SigChain = (function() {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              sigchain._enforce_eldest_key_ownership({
                parsed_keys: parsed_keys
              }, esc(__iced_deferrals.defer({
                lineno: 194
              })));
    ...
    function SigChain(_arg) {
      var eldest_kid, etime_seconds, kid, km, parsed_keys, uid, username, _ref1, _ref2;
      ...
      _ref1 = parsed_keys.key_managers;
      for (kid in _ref1) {
        km = _ref1[kid];
        if (((_ref2 = km.primary) != null ? _ref2.lifespan : void 0) != null) {
    ...
    SigChain.prototype.get_sibkeys = function(_arg) {
      ...
      return (function() {
        ...
        for (kid in this._valid_sibkeys) {
          if (this._kid_to_etime_seconds[kid] > now) {
            _results.push(kid);
          }
        }
        return _results;
    ...
    SigChain.prototype.get_subkeys = function(_arg) {
      ...
      return (function() {
        var _results;
        _results = [];
        for (kid in this._valid_subkeys) {
          if (this._kid_to_etime_seconds[kid] > now) {
            _results.push(kid);
          }
        }
    ...
    SigChain.prototype._add_new_link = function(_arg, cb) {
      var esc, link, parsed_keys, sig_blob, sig_cache, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sig_blob = _arg.sig_blob, parsed_keys = _arg.parsed_keys, sig_cache = _arg.sig_cache;
    ...
    SigChain.prototype._enforce_eldest_key_ownership = function(_arg, cb) {
      var eldest_km, esc, expected_email, identity, parsed_keys, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      parsed_keys = _arg.parsed_keys;
      esc = make_esc(cb, "SigChain._enforce_eldest_key_ownership");
      if (this._eldest_key_verified) {
        cb(null);
        return;
      }
      eldest_km = parsed_keys.key_managers[this._eldest_kid];
      (function(_this) {
        return (function(__iced_k) {
          if (eldest_km == null) {
            (function(__iced_k) {
  ...
  error_names = ["BAD_LINK_FORMAT", "CTIME_MISMATCH", "EXPIRED_SIBKEY", "FINGERPRINT_MISMATCH", "INVALID_SIBKEY", "KEY_OWNERSHIP", "KID_MISMATCH", "NONEXISTENT_KID", "NOT_LATEST_SUBCHAIN", "REVERSE_SIG_VERIFY_FAILED", "VERIFY_FAILED", "WRONG_UID", "WRONG_USERNAME", "WRONG_SEQNO", "WRONG_PREV"];
