...
(function() {
  var ChainLink, E, ParsedKeys, SIG_ID_SUFFIX, SigChain, StackedKeyManager, UID_LEN, a_json_parse, athrow, bufeq_secure, check_buffers_equal, check_link_payload_format, current_time_seconds, error_names, errors_map, iced, ie, kbpgp, make_esc, name, proofs, __iced_k, __iced_k_noop, _i, _len, _ref;
  ...
  exports.StackedKeyManager = StackedKeyManager = (function() {
    function StackedKeyManager(_arg) {
      var km;
      km = _arg.km;
      this._index = {};
      if (km != null) {
    ...
    StackedKeyManager.prototype.push = function(km) {
      var key_id, _i, _len, _ref1, _results;
      _ref1 = km.get_all_pgp_key_ids();
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        key_id = _ref1[_i];
        _results.push(this._index[key_id] = km);
      }
      return _results;
    };

    StackedKeyManager.prototype.make_sig_eng = function() {
      return new kbpgp.SignatureEngine({
        km: this
      });
    };

    StackedKeyManager.prototype.find_pgp_key = function(key_id) {
      var km;
      if ((km = this._index[key_id]) != null) {
        return km.find_pgp_key(key_id);
      }
      return null;
    };

    StackedKeyManager.prototype.fetch = function(key_ids, ops, cb) {
      var i, k, key_id, km, msg, _i, _len;
      ...
      msg = ((function() {
        ...
        _results = [];
        for (_j = 0, _len1 = key_ids.length; _j < _len1; _j++) {
          k = key_ids[_j];
          _results.push(k.toString('hex'));
        }
        return _results;
      })()).join(",");
      return cb(new Error("No key found for any of the key_ids in {" + msg + "}"), null, 0);
    };

    return StackedKeyManager;

  })();

  exports.ParsedKeys = ParsedKeys = ParsedKeys = (function() {
    ParsedKeys.parse = function(_arg, cb) {
      var bundle, default_eldest_kid_for_testing, esc, key_bundles, key_manager, kid, kid_str, kids_to_key_managers, kids_to_stacked_key_managers, opts, parsed_keys, skm, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
          ...
          _while = function(__iced_k) {
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                ...
                } else if ((skm = kids_to_stacked_key_managers[kid_str]) != null) {
                  skm.push(key_manager);
                } else {
                  kids_to_stacked_key_managers[kid_str] = new StackedKeyManager({
                    km: key_manager
                  });
                }
        ...
        return function() {
          parsed_keys = new ParsedKeys({
            ...
            kids_to_stacked_key_managers: kids_to_stacked_key_managers
          });
    ...
    function ParsedKeys(_arg) {
      var kids_to_key_managers, kids_to_stacked_key_managers;
      kids_to_key_managers = _arg.kids_to_key_managers, kids_to_stacked_key_managers = _arg.kids_to_stacked_key_managers;
      this._kids_to_key_managers = kids_to_key_managers;
      this._kids_to_stacked_key_managers = kids_to_stacked_key_managers;
    }
    ...
    ParsedKeys.prototype.get_stacked_key_manager = function(kid) {
      return this._kids_to_stacked_key_managers[kid] || this._kids_to_key_managers[kid];
    };
  ...
  exports.SigChain = SigChain = (function() {
    SigChain.replay = function(_arg, cb) {
      var eldest_kid, esc, parsed_keys, sig_blob, sig_blobs, sig_cache, sigchain, uid, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sig_blobs = _arg.sig_blobs, parsed_keys = _arg.parsed_keys, sig_cache = _arg.sig_cache, uid = _arg.uid, username = _arg.username, eldest_kid = _arg.eldest_kid;
    ...
    SigChain.prototype._add_new_link = function(_arg, cb) {
      var esc, link, sig_blob, sig_cache, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sig_blob = _arg.sig_blob, sig_cache = _arg.sig_cache;
    ...
    SigChain.prototype._revoke_keys_and_sigs = function(_arg, cb) {
      var kid, link, revoked_link, revoked_sibkey, revoked_subkey, sig_id, _i, _j, _len, _len1, _ref1, _ref2;
      link = _arg.link;
