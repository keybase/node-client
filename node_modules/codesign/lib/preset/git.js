...
(function() {
  var GitPreset, GlobberPreset, PresetBase, constants, iced, path, __iced_k, __iced_k_noop,
    ...
    GitPreset.prototype.handle = function(root_dir, path_to_file, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (path.basename(path_to_file) === '.git') {
            return __iced_k(res = constants.ignore_res.IGNORE);
          } else {
            (function(__iced_k) {
                ...
                if (!(_i < _len)) {
                  ...
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      ...
                      filename: "/Users/chris/git/keybase/codesign/src/preset/git.iced",
...
_break()
    ...
    GitPreset.prototype.get_globber = function(p, cb) {
          ...
          if (_this.globbers[p] == null) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/Users/chris/git/keybase/codesign/src/preset/git.iced",
                funcname: "GitPreset.get_globber"
              });
