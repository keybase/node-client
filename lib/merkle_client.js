...
(function() {
  ...
  MerkleClient = (function() {
    ...
    MerkleClient.prototype.lookup_path = function(_arg, cb) {
      var uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid;
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "/home/jacko/node-client/src/merkle_client.iced",
        funcname: "MerkleClient.lookup_path"
      });
      req.get({
    ...
    MerkleClient.prototype.find_and_verify = function(_arg, cb) {
      var err, esc, km, leaf, path_response, pathcheck_result, root, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid;
              ...
              (function(__iced_k) {
                if (pathcheck_result.uid !== uid) {
                  (function(__iced_k) {
                    ...
                    athrow(new Error("Expected uid " + uid + " does not match merkle response uid " + pathcheck_result.uid), __iced_deferrals.defer({
                      lineno: 154
                    }));
                    __iced_deferrals._fulfill();
                  })(__iced_k);
                ...
                var _ref1;
                _ref1 = Leaf.parse(pathcheck_result.leaf), err = _ref1[0], leaf = _ref1[1];
                (function(__iced_k) {
                  if (err != null) {
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                      ...
                      athrow(err, __iced_deferrals.defer({
                        lineno: 157
                      }));
                      __iced_deferrals._fulfill();
                    })(__iced_k);
