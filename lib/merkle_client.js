...
(function() {
  var E, MerkleClient, a_json_parse, athrow, createHash, iced, keys, log, make_esc, master_ring, merkle, req, __iced_k, __iced_k_noop, _merkle_client, _ref,
  ...
  master_ring = require('./kerying').master_ring;
  ...
  MerkleClient = (function(_super) {
    ...
    MerkleClient.prototype.verify_root_json = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref1;
          err = (a = root.hash) !== (b = json.hash) ? new E.VerifyError("Root hash mismatch: " + a + " != " + b) : (a = root.seqno) !== (b = json.seqno) ? new E.VerifyError("Sequence # mismatch: " + a + " != " + b) : (a = root.key_fingerprint) !== (b = (_ref1 = json.key) != null ? _ref1.fingerprint : void 0) ? new E.VerifyError("Fingerprint mismatch: " + a + " != " + b) : null;
          return cb(err);
        };
      })(this));
    };
        ...
        return function() {
          ...
          (function(__iced_k) {
            if (typeof val === "undefined" || val === null) {
              return __iced_k(err = new E.NotFoundError("No value " + _this.uid + " found in merkle tree"));
            } else {
              (function(__iced_k) {
                if (!Array.isArray(val) || val.length < 2) {
                  ...
                  (function(__iced_k) {
                    ...
                    _this.verify_root(root, __iced_deferrals.defer({
                      assign_fn: (function() {
                        return function() {
