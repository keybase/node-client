        ...
        return (function(__iced_k) {
          if (!_this._root) {
            (function(__iced_k) {
              ...
              return __iced_k(err == null ? (_this._root = body, hash = body.hash) : void 0);
            });
          } else {
            return __iced_k();
          }
