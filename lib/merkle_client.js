...
(function() {
  var C, E, MerkleClient, MerkleLeaf, MerkleLeafParser, Triple, a_json_parse, athrow, createHash, db, env, iced, keys, log, make_esc, master_ring, merkle, req, __iced_k, __iced_k_noop, _merkle_client, _ref,
  ...
  MerkleLeafParser = (function() {
    function MerkleLeafParser(val) {
      this.val = val;
    }

    MerkleLeafParser.prototype.parse = function() {
      var version;
      ...
      switch (version) {
        ...
        default:
          throw new E.BadMerkleLeafError("unknown leaf version: " + version);
      }
    };

    MerkleLeafParser.prototype.parse_v1 = function() {
      var pub;
    ...
    MerkleLeafParser.prototype.parse_v2 = function() {
      var priv, pub, _ref1;
      if (this.val.length < 2) {
        throw new E.BadMerkleLeafError("No public chain");
      }
      pub = this.parse_triple(this.val[1]);
      priv = (this.val.length > 2) && ((_ref1 = this.val[2]) != null ? _ref1.length : void 0) ? this.parse_triple(this.val[2]) : null;
      return new MerkleLeaf({
        pub: pub,
        priv: priv
      });
    ...
    MerkleLeafParser.prototype.match_hex = function(s) {
      return (typeof s === 'string') && !!(s.match(/^([a-fA-F0-9]*)$/)) && (s.length % 2 === 0);
    };

    MerkleLeafParser.prototype.parse_triple = function(val) {
      var msg;
      ...
      if (msg != null) {
        throw new E.BadMerkleLeafError(msg);
      }
      return new Triple({
        seqno: val[0],
        payload_hash: val[1],
    ...
    return MerkleLeafParser;

  })();

  exports.MerkleLeaf = MerkleLeaf = (function() {
    function MerkleLeaf(_arg) {
      this.pub = _arg.pub, this.priv = _arg.priv;
    }

    MerkleLeaf.prototype.get_public = function() {
      return this.pub;
    };

    MerkleLeaf.parse = function(version, val) {
          ...
          if (!_this._root) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/max/src/keybase/node-client/src/merkle_client.iced",
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if (err != null) {
            ...
            _ref1 = MerkleLeaf.parse(val), err = _ref1[0], leaf = _ref1[1];
          }
          (function(__iced_k) {
            if (err == null) {
              (function(__iced_k) {
