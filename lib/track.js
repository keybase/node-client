...
(function() {
  ...
  exports.Track = Track = (function() {
    function Track(_arg) {
      this.uid = _arg.uid, this.sig_chain = _arg.sig_chain, this.local = _arg.local, this.remote = _arg.remote;
    }
    ...
    Track.prototype._skip_remote_check = function(track_cert) {
      var last, last_change, last_check, rpri, _ref;
      rpri = constants.time.remote_proof_recheck_interval;
      return (track_cert != null) && (last = this.last() != null) && ((last_check = last != null ? last.ctime : void 0) != null) && ((last_change = track_cert.ctime) != null) && (last_check - last_change > rpri) && (((_ref = track_cert.remote_proofs) != null ? _ref.curr : void 0) === last.id);
    };
