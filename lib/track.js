...
(function() {
  ...
  exports.Track = Track = (function() {
    ...
    Track.prototype._check_remote_proof = function(rp) {
      ...
      } else if (!deq((_ref1 = link.payload_json()) != null ? _ref1.service : void 0, rkp.check_json_data)) {
    ...
    Track.prototype._skip_remote_check = function(track_cert) {
      ...
      return (track_cert != null) && (last = this.last() != null) && ((last_check = last != null ? last.ctime : void 0) != null) && ((last_change = track_cert.ctime) != null) && (last_check - last_change > rpri) && (((_ref = track_cert.seq_tail) != null ? _ref.payload_hash : void 0) === last.id);
    };
