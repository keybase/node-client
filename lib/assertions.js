...
(function() {
  var Assertions, E, GithubAssert, TwitterAssert, UnspecifiedAssert, WebServiceAssert, log,
  ...
  WebServiceAssert = (function() {
    function WebServiceAssert(key, val) {
      this.key = key;
      this.val = val;
    }

    WebServiceAssert.make = function(key, val) {
      var err, out;
      err = out = null;
      out = (function() {
        switch (key) {
    ...
    WebServiceAssert.prototype.set_remote_username = function(u) {
      return this._username = u;
    };

    WebServiceAssert.prototype.found = function() {
      return this._found = true;
    };

    WebServiceAssert.prototype.success = function(u) {
      this._uri = u;
      return this._success = true;
    };

    WebServiceAssert.prototype.check = function() {
      var ret;
      ret = false;
      if (!this._success) {
