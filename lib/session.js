...
(function() {
  var Config, E, ProgressBar, SC, Session, constants, env, iced, k, make_esc, prompt_email_or_username, prompt_passphrase, req, triplesec, __iced_k, __iced_k_noop, _fn, _ref, _session,
    __slice = [].slice;
