        ...
        return (function(__iced_k) {
          if (req.get_session()) {
            (function(__iced_k) {
              ...
              var _ref1;
              return __iced_k(typeof err === "undefined" || err === null ? (_this._logged_in = true, env().config.set("user.id", body.uid)) : err && (err instanceof E.KeybaseError) && ((typeof body !== "undefined" && body !== null ? (_ref1 = body.status) != null ? _ref1.name : void 0 : void 0) === "BAD_SESSION") ? err = null : void 0);
            });
          } else {
            return __iced_k();
          }
