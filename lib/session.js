...
(function() {
  var Config, E, ProgressBar, SC, Session, WordArray, constants, createHmac, env, iced, k, make_esc, prompt_email_or_username, prompt_passphrase, req, triplesec, __iced_k, __iced_k_noop, _fn, _ref, _session,
    __slice = [].slice;
  ...
  exports.Session = Session = (function() {
    ...
    Session.prototype.login = function(cb) {
      var args, email_or_username, esc, hmac_pwh, login_session, passphrase, salt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
