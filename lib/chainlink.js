...
(function() {
  ...
  SelfSig = (function(_super) {
    ...
    SelfSig.prototype.insert_into_table = function(_arg) {
      var table;
      table = _arg.table;
      return table[this.sig_type()] = this;
    };
  ...
  RemoteProof = (function(_super) {
    ...
    RemoteProof.prototype.insert_into_table = function(_arg) {
      var INSERT, S, keys, show_perm_failures, states, sub_id, table, _ref3;
      table = _arg.table, INSERT = _arg.INSERT, show_perm_failures = _arg.show_perm_failures;
      ...
      if (_ref3 = this.proof_state(), __indexOf.call(states, _ref3) >= 0) {
        ...
        return INSERT(table, keys, this);
      } else {
        return log.debug("Skipping remote proof in state " + (this.proof_state()) + ": " + (this.payload_json_str()));
      }
    };
  ...
  Track = (function(_super) {
    ...
    Track.prototype.insert_into_table = function(_arg) {
      var MAKE, id, table, _ref3, _ref4;
      table = _arg.table, MAKE = _arg.MAKE;
      if ((id = (_ref3 = this.body()) != null ? (_ref4 = _ref3.track) != null ? _ref4.id : void 0 : void 0) == null) {
        ...
        return log.debug(this.payload_json_str());
      } else {
        return MAKE(table, this.sig_type(), {})[id] = this;
      }
    };
  ...
  Cryptocurrency = (function(_super) {
    ...
    Cryptocurrency.prototype.insert_into_table = function(_arg) {
      var MAKE, err, id, ret, table, _ref3, _ref4, _ref5;
      table = _arg.table, MAKE = _arg.MAKE;
      ...
      if ((id = (_ref3 = this.body()) != null ? (_ref4 = _ref3.cryptocurrency) != null ? _ref4.address : void 0 : void 0) == null) {
        ...
        MAKE(table, this.sig_type(), {})[ret.version] = this;
      }
  ...
  Revoke = (function(_super) {
    ...
    Revoke.prototype.insert_into_table = function(_arg) {
      var index, link, sig_id, _ref3, _ref4;
      index = _arg.index;
      log.debug("+ Revoke::insert_into_table " + (this.sig_id()));
      if (!(sig_id = (_ref3 = this.body()) != null ? (_ref4 = _ref3.revoke) != null ? _ref4.sig_id : void 0 : void 0)) {
        log.warn("Cannot find revoke sig_id in signature: " + (this.payload_json_str()));
      ...
      return log.debug("- Revoke::insert_into_table " + (this.sig_id()));
    };
  ...
  Untrack = (function(_super) {
    ...
    Untrack.prototype.insert_into_table = function(_arg) {
      var id, index, link, table, _ref3, _ref4, _ref5;
      table = _arg.table, index = _arg.index;
      if ((id = (_ref3 = this.body()) != null ? (_ref4 = _ref3.untrack) != null ? _ref4.id : void 0 : void 0) == null) {
        return log.warn("Mssing untrack in signature: " + (this.payload_json_str()));
      } else if ((link = (_ref5 = table[ST.TRACK]) != null ? _ref5[id] : void 0) == null) {
        return log.warn("Unexpected untrack of " + id + " in signature chain");
      } else if (link.is_revoked()) {
        return log.debug("| Tracking was already revoked for " + id + " (ignoring untrack)");
      } else {
        return link.revoke();
      }
    };
