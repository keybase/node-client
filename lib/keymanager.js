...
(function() {
  var BufferOutStream, E, KeyManager, PackageJson, constants, env, iced, init, init_env, make_esc, master_ring, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.KeyManager = KeyManager = (function() {
    ...
    KeyManager.prototype._import_from_p3skb = function(_arg, cb) {
      var err, esc, prompter, raw, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
