...
(function() {
  var ASP, BufferOutStream, E, KeyManager, PackageJson, constants, env, iced, init, init_env, make_esc, make_scrypt_progress_hook, master_ring, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.KeyManager = KeyManager = (function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase-node-client/src/keymanager.iced",
    ...
    KeyManager.prototype._gen = function(cb) {
      var args, email, err, esc, h, key_id_64, m, out, script, stderr, stdin, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return function() {
          ...
          (function(__iced_k) {
            if ((m = stderr.data().toString('utf8').match(/key ([A-F0-9]{16}) marked as/))) {
              ...
              return __iced_k(err = new E.GenerationError("Failed to parse output of key generation"));
            }
          })(function() {
            return cb(err);
          });
