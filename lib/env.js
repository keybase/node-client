...
(function() {
  ...
  Env = (function() {
          ...
          if (!(_this.env.XDG_CONFIG_HOME || _this.env.XDG_CACHE_HOME || _this.env.XDG_DATA_HOME)) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/max/src/keybase/node-client/src/env.iced",
    ...
    Env.prototype.get_tor_paranoid = function() {
      return this.get_opt({
        env: function(e) {
          return e.TOR_PARANOID;
        },
        arg: function(a) {
          return a.tor_paranoid;
        },
        config: function(c) {
          var _ref1;
          return (_ref1 = c.tor) != null ? _ref1.paranoid : void 0;
        },
        dflt: function() {
          return false;
        }
