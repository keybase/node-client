...
(function() {
  ...
  Env = (function() {
    ...
    Env.prototype.maybe_fallback_to_layout_v1 = function(cb) {
      var err, old_config, stat, ___iced_passed_deferral, __iced_deferrals, __iced_k;
        ...
        return (function(__iced_k) {
          if (!(_this.env.XDG_CONFIG_HOME || _this.env.XDG_CACHE_HOME || _this.env.XDG_DATA_HOME)) {
            ...
            (function(__iced_k) {
              ...
              console.log(err);
              console.log(stat);
              return __iced_k((err == null) && (typeof stat !== "undefined" && stat !== null ? stat.isFile() : void 0) ? (console.log("ok, we're in it!"), _this.kbpath = _this.kbpath.fallback_to_v1()) : err.code === 'ENOENT' ? err = null : void 0);
            });
          } else {
            return __iced_k();
          }
    ...
    Env.prototype._get_home = function() {
      return this.get_opt({
        env: function(e) {
