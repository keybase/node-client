  ...
  Env = (function() {
    ...
    Env.prototype.get_tmp_keyring_dir = function() {
      return this.get_opt({
        ...
        arg: function(a) {
          return a["tmp-keyring-dir"];
        },
        config: function(c) {
          var _ref;
          return c != null ? (_ref = c.files) != null ? _ref.tmp_keyring_dir : void 0 : void 0;
        },
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_keyring_dir);
        }
      });
    };

    Env.prototype.get_tmp_gpg_sec_keyring = function() {
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_TMP_GPG_SEC_KEYRING;
        },
        arg: function(a) {
          return a["tmp-gpg-sec-keyring"];
        },
        config: function(c) {
          var _ref, _ref1;
          return c != null ? (_ref = c.files) != null ? (_ref1 = _ref.tmp_gpg) != null ? _ref1.sec_keyring : void 0 : void 0 : void 0;
        },
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_gpg.sec_keyring);
        }
      });
    };

    Env.prototype.get_tmp_gpg_pub_keyring = function() {
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_TMP_GPG_SEC_KEYRING;
        },
        arg: function(a) {
          return a["tmp-gpg-pub-keyring"];
        },
        config: function(c) {
          var _ref, _ref1;
          return c != null ? (_ref = c.files) != null ? (_ref1 = _ref.tmp_gpg) != null ? _ref1.pub_keyring : void 0 : void 0 : void 0;
        },
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_gpg.pub_keyring);
        }
      });
    };

    Env.prototype.get_tmp_gpg_trustdb = function() {
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_TMP_GPG_TRUSTDB;
        },
        arg: function(a) {
          return a["tmp-gpg-trustdb"];
        },
        config: function(c) {
          var _ref, _ref1;
          return c != null ? (_ref = c.files) != null ? (_ref1 = _ref.tmp_gpg) != null ? _ref1.trustdb : void 0 : void 0 : void 0;
        },
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_gpg.trustdb);
        }
      });
    };
    ...
    Env.prototype.get_key_server = function() {
      var self;
      self = this;
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_KEY_SERVER;
        },
        arg: function(a) {
          return a.key_server;
        },
        ...
        dflt: function() {
          return "hkp://" + (self.get_host()) + ":" + (self.get_port());
        }
      });
    };
