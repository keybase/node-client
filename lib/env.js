...
(function() {
  var Env, FN, RunMode, SRV, Strictness, constants, home, join, kbpath, make_email, make_full_username, _env, _ref;
  ...
  Env = (function() {
    ...
    Env.prototype.get_config_dir = function() {
      return this.kbpath.config_dir('keybase');
    };
    ...
    Env.prototype.get_config_filename = function() {
      return this.get_opt({
        ...
        dflt: (function(_this) {
          return function() {
            return join(_this.get_config_dir(), FN.config_file);
          };
        })(this)
      });
    };
    ...
    Env.prototype.get_session_filename = function() {
      return this.get_opt({
        ...
        dflt: (function(_this) {
          return function() {
            return join(_this.get_config_dir(), FN.session_file);
          };
        })(this)
      });
    };
    ...
    Env.prototype.get_db_filename = function() {
      return this.get_opt({
        ...
        dflt: (function(_this) {
          return function() {
            return join(_this.get_config_dir(), FN.db_file);
          };
        })(this)
      });
    };
    ...
    Env.prototype.get_tmp_keyring_dir = function() {
      return this.get_opt({
        ...
        dflt: (function(_this) {
          return function() {
            return join(_this.get_config_dir(), FN.tmp_keyring_dir);
          };
        })(this)
      });
    };
