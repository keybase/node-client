...
(function() {
  ...
  Env = (function() {
    ...
    Env.prototype.get_no_merkle_checks = function() {
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_NO_MERKLE_CHECKS;
        },
        arg: function(a) {
          return a.no_merkle_checks;
        },
        config: function(c) {
          return c.no_merkle_checks;
        },
        dflt: function() {
          return false;
        }
    ...
    Env.prototype.get_merkle_key_fingerprints = function() {
      ...
      return this.get_opt({
        env: function(e) {
          return split(e.KEYBASE_MERKLE_KEY_FINGERPRINT);
        },
        arg: function(a) {
