...
(function() {
  ...
  Env = (function() {
    ...
    Env.prototype.get_ca_cert_dir = function() {
      return this.get_opt({
        env: function(e) {
          return e.KEYBASE_CA_CERT_DIR;
        },
        arg: function(a) {
          return a.ca_cert_dir;
        },
        config: function(c) {
          var _ref1;
          return c != null ? (_ref1 = c.files) != null ? _ref1.ca_cert_dir : void 0 : void 0;
        },
        dflt: (function(_this) {
          return function() {
            return join(_this.get_home(), FN.config_dir, FN.ca_cert_dir);
          };
        })(this)
      });
    };
    ...
    Env.prototype.get_key_server = function() {
      ...
      return this.get_opt({
        ...
        dflt: function() {
          return "hkp" + (self.get_no_tls() ? '' : 's') + "://" + (self.get_host()) + ":" + (self.get_port());
        }
      });
    };
