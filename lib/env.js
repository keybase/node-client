  ...
  Env = (function() {
    ...
    Env.prototype.get_tmp_gpg_sec_keyring = function() {
      return this.get_opt({
        ...
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_pgp.sec_keyring);
        }
      });
    };
    ...
    Env.prototype.get_tmp_gpg_pub_keyring = function() {
      return this.get_opt({
        ...
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_pgp.pub_keyring);
        }
      });
    };
    ...
    Env.prototype.get_tmp_gpg_trustdb = function() {
      return this.get_opt({
        ...
        dflt: function() {
          return join(home(), FN.config_dir, FN.tmp_pgp.trustdb);
        }
      });
    };
