...
(function() {
  var BAD_X, Base, Bitbucket, CHECK, Coinbase, Dns, E, GenericWebSite, Github, HackerNews, Proof, Reddit, SocialNetwork, Twitter, alloc_stub, cheerio, colors, env, iced, log, my_request, proofs, proxyca, request, root_certs, semver, tor, __iced_k, __iced_k_noop, _certs, _ref,
  ...
  exports.Bitbucket = Bitbucket = (function(_super) {
    __extends(Bitbucket, _super);

    function Bitbucket() {}

    Bitbucket.prototype.get_scraper_klass = function() {
      var ret;
    ...
    Bitbucket.prototype.which = function() {
      return "bitbucket";
    };
