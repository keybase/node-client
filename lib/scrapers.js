...
(function() {
  var BAD_X, Base, CHECK, E, GenericWebSite, Github, SocialNetwork, Twitter, cheerio, colors, env, iced, log, proofs, request, __iced_k, __iced_k_noop, _ref,
  ...
  Base = (function() {
    ...
    Base.prototype.validate = function(arg, cb) {
      var msg, ok, rc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        ...
        return function() {
          ok = rc === proofs.constants.v_codes.OK;
          msg = _this.format({
            arg: arg,
            ok: ok
          });
  ...
  exports.make = function(type, cb) {
    var PT, err, klass, scraper, w;
