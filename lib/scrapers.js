...
(function() {
  ...
  Base = (function() {
    ...
    Base.prototype.validate = function(arg, cb) {
      var err, msg, ok, rc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        ...
        return function() {
          ok = !(typeof err !== "undefined" && err !== null) && (rc === proofs.constants.v_codes.OK);
          msg = _this.format({
            arg: arg,
            ok: ok
          });
          return cb(err, rc, msg);
        };
      })(this));
    };
  ...
  SocialNetwork = (function(_super) {
    ...
    SocialNetwork.prototype.format = function(_arg) {
      var arg, ok;
  ...
  exports.GenericWebSite = GenericWebSite = (function(_super) {
    ...
    GenericWebSite.prototype.format = function(_arg) {
