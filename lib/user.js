      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              if (self && tor.paranoid()) {
                return __iced_k(log.debug("| Skipping remote server check for ME in tor paranoid mode"));
              } else {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    if (self && tor.paranoid()) {
                      return __iced_k(log.debug("| Skipping merkle-tree check for ME in tor paranoid mode"));
                    } else {
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                          parent: ___iced_passed_deferral,
