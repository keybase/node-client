...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.import_public_key = function(cb) {
      var args, data, err, out, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(__iced_k) {
        ...
        if ((data = (_ref = _this.public_keys) != null ? (_ref1 = _ref.primary) != null ? _ref1.bundle : void 0 : void 0) != null) {
          ...
          (function(__iced_k) {
            ...
            return __iced_k(typeof err !== "undefined" && err !== null ? err = new E.ImportError("key import error: {err.message}") : void 0);
          });
        } else {
          return __iced_k(err = new E.ImportError("no public key found"));
        }
      })(function() {
        return cb(err);
      });
