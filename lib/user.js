...
(function() {
  var E, GpgKey, IS, KeyManager, SigChain, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, constants, db, deepeq, env, filter, iced, log, make_esc, req, session, unix_time, __iced_k, __iced_k_noop, _ref;
