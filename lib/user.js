...
(function() {
  ...
  exports.User = User = (function() {
      ...
      (function(__iced_k) {
        if ((last = _this.sig_chain.last()) != null) {
          ...
          (function(__iced_k) {
            ...
            } else if ((a = out.toString('utf8')) !== (b = last.payload_json_str())) {
    ...
    User.prototype.verify_userid = function(cb) {
      var email, emails, err, found, link, links, search_for, uids, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(__iced_k) {
    ...
    User.prototype.verify = function(cb) {
      ...
      (function(__iced_k) {
        ...
        _this.verify_sig(esc(__iced_deferrals.defer({
          lineno: 259
        })));
        __iced_deferrals._fulfill();
      })(function() {
        (function(__iced_k) {
          ...
          _this.verify_userid(esc(__iced_deferrals.defer({
            lineno: 260
          })));
          __iced_deferrals._fulfill();
        })(function() {
