  ...
  exports.User = User = (function() {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    var _ref8;
                    if (require_public_key && (((_ref8 = user.merkle_data) != null ? _ref8.eldest_kid : void 0) == null)) {
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                          parent: ___iced_passed_deferral,
                          filename: "/home/jacko/node-client/src/user.iced",
    ...
    User.prototype.fingerprint = function(upper_case) {
      ...
      if (this._fingerprint == null) {
        this._fingerprint = {
          lc: (_ref7 = this.default_key()) != null ? _ref7.fingerprint().toString('hex') : void 0
        };
    ...
    User.prototype.import_public_keys = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _i, _len, _ref7, _results, _while;
          _ref7 = _this.gpg_keys;
          _len = _ref7.length;
          _i = 0;
          _results = [];
    ...
    User.prototype._verify = function(_arg, cb) {
      var esc, has_links, opts, parsed_keys, self, tor_msg, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      opts = _arg.opts, parsed_keys = _arg.parsed_keys, self = _arg.self;
      esc = make_esc(cb, "User::verify");
      has_links = this.sig_chain.last() != null;
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (self && !has_links) {
            return __iced_k(_this.sibkeys = [parsed_keys.get_key_manager(_this.merkle_data.eldest_kid)]);
          } else {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
              ...
              _this.sig_chain.verify_sig({
                ...
                assign_fn: (function(__slot_1) {
                  return function() {
                    return __slot_1.sibkeys = arguments[0];
                  };
                })(_this),
                lineno: 589
              })));
    ...
    User.prototype.gen_track_obj = function() {
      var out, pkp, _ref10, _ref7, _ref8, _ref9;
      pkp = this.public_keys.primary;
      out = {
        basics: filter(this.basics, ["id_version", "last_id_change", "username"]),
        id: this.id,
        key: {
          kid: (_ref7 = this.merkle_data) != null ? _ref7.eldest_kid : void 0
        },
        seq_tail: (_ref8 = this.sig_chain) != null ? (_ref9 = _ref8.true_last()) != null ? _ref9.to_track_obj() : void 0 : void 0,
        remote_proofs: (_ref10 = this.sig_chain) != null ? _ref10.remote_proofs_to_track_obj() : void 0,
        ctime: unix_time()
      };
      return out;
    };
