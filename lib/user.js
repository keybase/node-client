...
(function() {
  ...
  exports.User = User = (function() {
          ...
          if (force_store || _this._dirty) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/chris/git/keybase/node-client/src/user.iced",
                funcname: "User.store"
              });
              db.put({
                key: _this.id,
    ...
    User.load = function(_arg, cb) {
      var cache, err, ki64, require_public_key, ret, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, ki64 = _arg.ki64, require_public_key = _arg.require_public_key, cache = _arg.cache;
      err = null;
      (function(_this) {
        return (function(__iced_k) {
    ...
    User._load2 = function(_arg, cb) {
      var cache, changed, err, esc, force_store, k, ki64, local, remote, require_public_key, user, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, ki64 = _arg.ki64, require_public_key = _arg.require_public_key, cache = _arg.cache;
    ...
    User.prototype._load_me_2 = function(_arg, cb) {
      var do_install, err, esc, install_key, load_secret, maybe_secret, secret, un, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      secret = _arg.secret, maybe_secret = _arg.maybe_secret, install_key = _arg.install_key;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            if ((typeof err === "undefined" || err === null) && maybe_secret) {
    ...
    User.prototype.gen_remote_proof_gen = function(_arg, cb) {
      var arg, esc, g, klass, remote_name_normalized, sig_id, supersede, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
