...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.resolve_user_name = function(_arg, cb) {
      var body, err, esc, uri, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username;
          ...
          (function(__iced_k) {
            if (!uri.is_keybase()) {
              (function(__iced_k) {
                ...
                return __iced_k(body.them.length === 0 ? err = new E.NotFoundError("No user found for '" + username + "'") : body.them.length > 1 ? err = new E.AmbiguityError("Multiple results returned for '" + username + "'; expected only 1") : (username = body.them[0].basics.username, assertion = uri));
              });
            } else {
              return __iced_k();
            }
