...
(function() {
  var E, KeyManager, SigChain, TrackerProofGen, User, constants, db, deepeq, gpg, iced, log, make_esc, req, session, __iced_k, __iced_k_noop;
  ...
  TrackerProofGen = require('./sigs').TrackerProofGen;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.track = function(_arg, cb) {
      var esc, g, last_link, track_obj, trackee, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      trackee = _arg.trackee, track_obj = _arg.track_obj;
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          var _ref;
          last_link = (_ref = _this.sig_chain) != null ? _ref.last() : void 0;
