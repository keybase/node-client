...
(function() {
  var E, KeyManager, SigChain, TrackerProofGen, User, constants, db, deepeq, filter, gpg, iced, log, make_esc, req, session, __iced_k, __iced_k_noop;
