...
(function() {
  var E, GpgKey, KeyManager, SigChain, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, constants, db, deepeq, env, filter, iced, log, make_esc, req, session, unix_time, __iced_k, __iced_k_noop, _ref;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.update_sig_chain = function(remote, cb) {
      var did_update, err, seqno, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref1, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    User.prototype._load_me_2 = function(cb) {
      ...
      this.pubkey = new GpgKey(this, false);
      un = this.username();
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.pubkey.query_key(esc(__iced_deferrals.defer({
            lineno: 223
          })));
          __iced_deferrals._fulfill();
        });
    ...
    User.prototype.import_public_key = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.pubkey.import_key(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return err = arguments[0];
              };
    ...
    User.prototype.remove_key = function(cb) {
      return (new GpgKey(this, false)).remove(cb);
    };
