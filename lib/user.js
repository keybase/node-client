...
(function() {
  ...
  exports.User = User = (function() {
      ...
      (function(__iced_k) {
        ...
        if ((data = (_ref = _this.public_keys) != null ? (_ref1 = _ref.primary) != null ? _ref1.bundle : void 0 : void 0) != null) {
          ...
          (function(__iced_k) {
            ...
            return __iced_k(typeof err !== "undefined" && err !== null ? err = new E.ImportError("" + (_this.username()) + ": key import error: {err.message}") : void 0);
          });
        } else {
    ...
    User.prototype.temporary_import_public_key = function(cb) {
      var err, found, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      found = false;
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/user.iced",
          funcname: "User.temporary_import_public_key"
        });
        _this.query_key({
          secret: false
        }, __iced_deferrals.defer({
            ...
            (function(__iced_k) {
              if ((err instanceof E.NoLocalKeyError) != null) {
                (function(__iced_k) {
                  ...
                  _this.import_public_key(__iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return err = arguments[0];
                      };
