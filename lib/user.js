...
(function() {
  var E, GE, IS, SigChain, TmpKeyRing, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, athrow, constants, db, deepeq, env, filter, iced, load_key, log, make_esc, master_ring, req, session, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.User = User = (function() {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              var _ref4;
              if (require_public_key && (((_ref4 = remote.public_keys) != null ? _ref4.primary : void 0) == null)) {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
                    filename: "/Users/max/src/keybase-node-client/src/user.iced",
        ...
        return (function(__iced_k) {
          if ((username = env().get_username()) == null) {
            (function(__iced_k) {
              ...
              athrow(new E.NoUsernameError("no username for current user"), esc(__iced_deferrals.defer({
                lineno: 285
              })));
              __iced_deferrals._fulfill();
            })(__iced_k);
    ...
    User.prototype.has_public_key = function(cb) {
      var err, key, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      log.debug("+ " + (this.username()) + ": has_public_key");
      key = master_ring().make_key_from_user(this, false);
      ret = false;
      (function(_this) {
        return (function(__iced_k) {
        ...
        return function() {
          if (typeof err === "undefined" || err === null) {
            ret = true;
          } else if ((err instanceof E.NoLocalKeyError) || (err instanceof E.NoRemoteKeyError)) {
            ret = false;
          } else {
            ret = true;
          }
          log.debug("- " + (_this.username()) + ": has_public_key: ret=" + ret + "; err=" + err);
          return cb(err, ret);
        };
      })(this));
    };
    ...
    User.prototype.list_remote_proofs = function() {
      var _ref3;
      return (_ref3 = this.sig_chain) != null ? _ref3.list_remote_proofs() : void 0;
    };
