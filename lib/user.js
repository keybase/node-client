...
(function() {
  var E, KeyManager, SigChain, TrackerProofGen, User, constants, db, deepeq, env, filter, gpg, iced, log, make_esc, req, session, __iced_k, __iced_k_noop;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.gen_track_proof_gen = function(_arg, cb) {
      var esc, g, last_link, track_obj, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid, track_obj = _arg.track_obj;
