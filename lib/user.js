...
(function() {
  var BufferOutStream, E, SigChain, User, constants, db, deepeq, gpg, grep, iced, make_esc, parse, req, strip, __iced_k, __iced_k_noop, _ref;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.verify_userid = function(cb) {
      var err, uids, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(__iced_k) {
