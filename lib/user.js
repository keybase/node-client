...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.verify_sig = function(cb) {
      var args, err, last, out, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      (function(__iced_k) {
        var _ref;
        if ((_ref = _this.sig_chain) != null ? _ref.length : void 0) {
          last = _this.sig_chain.slice(-1)[0];
          args = ["--verify"];
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
            ...
            return __iced_k(err != null ? err = new E.VerifyError("" + (_this.username()) + ": failed to verify signature") : void 0);
          });
        } else {
          return __iced_k();
        }
