...
(function() {
  var E, GE, IS, PackageJson, QuarantinedKeyRing, SigChain, TmpKeyRing, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, akatch, assertion, athrow, chain_err, colors, constants, db, deepeq, env, filter, fpeq, iced, load_key, log, make_esc, master_ring, req, session, tor, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.public_key_bundle = function() {
      var _ref6, _ref7;
      return (_ref6 = this.public_keys) != null ? (_ref7 = _ref6.primary) != null ? _ref7.bundle : void 0 : void 0;
    };
    ...
    User.prototype.load_sig_chain_from_storage = function(cb) {
      var err, ph, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref6;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      log.debug("+ load sig chain from local storage");
      this.last_sig = ((_ref6 = this.sigs) != null ? _ref6.last : void 0) || {
        seqno: 0
      };
      (function(_this) {
        return (function(__iced_k) {
    ...
    User.prototype.update_sig_chain = function(remote, cb) {
      var did_update, err, seqno, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref6, _ref7;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      seqno = remote != null ? (_ref6 = remote.sigs) != null ? (_ref7 = _ref6.last) != null ? _ref7.seqno : void 0 : void 0 : void 0;
    ...
    User._load2 = function(_arg, cb) {
      var cache, changed, err, esc, force_store, k, ki64, local, remote, require_public_key, secret, self, user, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, ki64 = _arg.ki64, require_public_key = _arg.require_public_key, cache = _arg.cache, self = _arg.self, secret = _arg.secret;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              if (self && tor.strict()) {
                return __iced_k(log.warn("Tor strict mode: " + (colors.bold('not')) + " syncing " + (colors.bold('my')) + " profile with the server"));
              } else {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
              ...
              (function(__iced_k) {
                var _ref7;
                if (require_public_key && (((_ref7 = remote.public_keys) != null ? _ref7.primary : void 0) == null)) {
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/Users/max/src/keybase/node-client/src/user.iced",
                ...
                (function(__iced_k) {
                  if (typeof local !== "undefined" && local !== null) {
                    ...
                    (function(__iced_k) {
                      if (typeof remote !== "undefined" && remote !== null) {
                        ...
                        return __iced_k(tor.strict() ? err = new E.TorStrictError("Can't load your info from the server in Tor-strict mode") : err = new E.NotFoundError("User " + username + " wasn't found"));
                      }
                    })(__iced_k);
                  }
                })(function() {
                  (function(__iced_k) {
                    ...
                    (function(__iced_k) {
                      if (self && tor.strict()) {
                        return __iced_k(log.debug("| Skipping merkle-tree check for ME in Tor strict mode"));
                      } else {
                        (function(__iced_k) {
                          __iced_deferrals = new iced.Deferrals(__iced_k, {
                            parent: ___iced_passed_deferral,
    ...
    User.load_from_server = function(_arg, cb) {
      var args, body, err, ret, secret, self, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      self = _arg.self, secret = _arg.secret, username = _arg.username;
      log.debug("+ " + username + ": load user from server");
      (function(_this) {
        return (function(__iced_k) {
          if ((ret = User.server_cache[username]) != null) {
            return __iced_k(log.debug("| hit server cache"));
          } else {
            args = {
            ...
            (function(__iced_k) {
              ...
              ret = null;
              return __iced_k(typeof err === "undefined" || err === null ? (ret = new User(body.them), ret.set_logged_in(), User.server_cache[username] = ret) : void 0);
            });
          }
        });
      })(this)((function(_this) {
    ...
    User.prototype.fingerprint = function(upper_case) {
      ...
      if (this._fingerprint == null) {
        this._fingerprint = {
          lc: (_ref6 = this.public_keys) != null ? (_ref7 = _ref6.primary) != null ? (_ref8 = _ref7.key_fingerprint) != null ? _ref8.toLowerCase() : void 0 : void 0 : void 0
        };
        this._fingerprint.uc = (_ref9 = this._fingerprint.lc) != null ? _ref9.toUpperCase() : void 0;
      }
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                _this.verify(verify_opts || {}, esc(__iced_deferrals.defer({
                  lineno: 452
                })));
                __iced_deferrals._fulfill();
              })(function() {
    ...
    User.prototype.gen_track_obj = function() {
      ...
      out = {
        ...
        seq_tail: (_ref6 = this.sig_chain) != null ? (_ref7 = _ref6.true_last()) != null ? _ref7.to_track_obj() : void 0 : void 0,
        remote_proofs: (_ref8 = this.sig_chain) != null ? _ref8.remote_proofs_to_track_obj() : void 0,
        ctime: unix_time()
      };
      return out;
    };
