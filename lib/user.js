...
(function() {
  var E, KeyManager, SigChain, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, constants, db, deepeq, env, filter, gpg, iced, log, make_esc, req, session, tmpgpg, __iced_k, __iced_k_noop, _ref;
