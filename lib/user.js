...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.lookup_username_from_key_id_64 = function(ki64, cb) {
      var args, body, esc, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase-node-client/src/user.iced",
            funcname: "User.lookup_username_from_key_id_64"
          });
    ...
    User.load_from_storage = function(_arg, cb) {
      ...
      type = username != null ? constants.lookup.username : constants.lookup.key_id_64_to_user;
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
