...
(function() {
  ...
  exports.User = User = (function() {
    User.FIELDS = ["basics", "public_keys", "id", "sigs", "private_keys"];
    ...
    User.prototype.public_key_bundle = function() {
      var _ref3, _ref4;
      return (_ref3 = this.public_keys) != null ? (_ref4 = _ref3.primary) != null ? _ref4.bundle : void 0 : void 0;
    };

    User.prototype.private_key_bundle = function() {
      var _ref3, _ref4;
      return (_ref3 = this.private_keys) != null ? (_ref4 = _ref3.primary) != null ? _ref4.bundle : void 0 : void 0;
    };
    ...
    User.prototype.check_key = function(_arg, cb) {
      var err, key, ret, secret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      secret = _arg.secret;
      ret = {};
        ...
        return (function(__iced_k) {
          if (_this.fingerprint() != null) {
            ...
            (function(__iced_k) {
              ...
              return __iced_k(typeof err === "undefined" || err === null ? ret.local = true : err instanceof E.NoLocalKeyError ? (err = null, ret.local = false) : void 0);
            });
          } else {
            return __iced_k();
          }
    ...
    User.prototype.gen_track_proof_gen = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref3;
          last_link = (_ref3 = _this.sig_chain) != null ? _ref3.true_last() : void 0;
    ...
    User.prototype.gen_track_obj = function() {
      ...
      out = {
        ...
        seq_tail: (_ref3 = this.sig_chain) != null ? (_ref4 = _ref3.true_last()) != null ? _ref4.to_track_obj() : void 0 : void 0,
        remote_proofs: (_ref5 = this.sig_chain) != null ? _ref5.remote_proofs_to_track_obj() : void 0,
        ctime: unix_time()
      };
      return out;
    };
