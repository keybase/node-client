...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.load_public_key = function(_arg, cb) {
      var can_fail, err, query, signer, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      signer = _arg.signer, can_fail = _arg.can_fail;
        ...
        return (function(__iced_k) {
          if (_this.key == null) {
            (function(__iced_k) {
              ...
              return __iced_k((err != null) && (err instanceof GE.GpgError) && can_fail ? (log.debug("| Failed to load a key for " + (_this.username()) + ", but we're allowed to failed: " + err.message), err = null) : void 0);
            });
          } else {
            return __iced_k();
          }
