...
(function() {
  var E, KeyManager, SigChain, TrackerProofGen, UntrackerProofGen, User, constants, db, deepeq, env, filter, gpg, iced, log, make_esc, req, session, __iced_k, __iced_k_noop, _ref;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.get_fingerprint = function() {
      var _ref1, _ref2;
      if (this.fingerprint == null) {
        this.fingerprint = (_ref1 = this.public_keys) != null ? (_ref2 = _ref1.primary) != null ? _ref2.key_fingerprint : void 0 : void 0;
      }
    ...
    User.prototype.query_key = function(_arg, cb) {
      ...
      (function(__iced_k) {
        var _ref1;
        if ((fp = (_ref1 = _this.get_fingerprint()) != null ? _ref1.toUpperCase() : void 0) != null) {
          args = ["-" + (secret ? 'K' : 'k'), fp];
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
    ...
    User.prototype.remove_key = function(cb) {
      ...
      un = this.username();
      uid = this.id;
      fingerprint = this.get_fingerprint().toUpperCase();
