...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.load_local_track = function(uid, cb) {
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/user.iced",
          funcname: "User.load_local_track"
        });
        db.get({
    ...
    User.prototype.find_track = function(them, cb) {
      var err, track, tuid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      ...
      (function(__iced_k) {
        var _ref;
        if ((track = (_ref = _this.sig_chain) != null ? _ref.get_track(tuid) : void 0) == null) {
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
              filename: "src/user.iced",
              funcname: "User.find_track"
            });
            _this.load_local_track(tuid, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  err = arguments[0];
