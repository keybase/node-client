...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.load = function(_arg, cb) {
      var changed, err, esc, force_store, k, ki64, local, remote, require_public_key, user, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    User.prototype.check_merkle_tree = function(cb) {
      return this.sig_chain.check_merkle_tree(cb);
    };
