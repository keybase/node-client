...
(function() {
  var E, IS, SigChain, TmpKeyRing, TrackWrapper, TrackerProofGen, UntrackerProofGen, User, constants, db, deepeq, env, filter, iced, load_key, log, make_esc, master_ring, req, session, unix_time, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  _ref1 = require('./keyring'), TmpKeyRing = _ref1.TmpKeyRing, load_key = _ref1.load_key, master_ring = _ref1.master_ring;
