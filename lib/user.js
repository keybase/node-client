...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User._load2 = function(_arg, cb) {
      var cache, changed, err, esc, fetched_from_server, force_store, k, ki64, local, local_id_version, local_seqno, remote, require_public_key, secret, self, user, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, ki64 = _arg.ki64, require_public_key = _arg.require_public_key, cache = _arg.cache, self = _arg.self, secret = _arg.secret;
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              if (self && tor.strict()) {
                ...
                local_id_version = typeof local !== "undefined" && local !== null ? (_ref8 = local.basics) != null ? _ref8.id_version : void 0 : void 0;
                local_seqno = typeof local !== "undefined" && local !== null ? (_ref9 = local.merkle_data) != null ? _ref9.seqno : void 0 : void 0;
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
                    filename: "/home/jacko/node-client/src/user.iced",
                  ...
                  (function(__iced_k) {
                    ...
                    (function(__iced_k) {
                      ...
                      (function(__iced_k) {
                        ...
                        (function(__iced_k) {
                          if (user.sig_chain.last() == null) {
                            return __iced_k(log.debug("| " + username + ": sigchain is empty, skipping verify"));
                          } else {
                            ...
                            (function(__iced_k) {
                              ...
                              return __iced_k(log.debug("- " + username + ": verified signatures"));
                            });
                          }
                        })(function() {
                          (function(__iced_k) {
    ...
    User.load_from_server = function(_arg, cb) {
      var args, body, esc, leaf, local_id_version, local_seqno, merkle_data, ret, root, secret, self, server_id_version, server_seqno, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      self = _arg.self, secret = _arg.secret, username = _arg.username, local_id_version = _arg.local_id_version, local_seqno = _arg.local_seqno;
      ...
      (function(_this) {
        ...
        return function() {
          if (typeof leaf !== "undefined" && leaf !== null) {
            ...
            if (server_id_version === local_id_version && server_seqno === local_seqno) {
