...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.gen_remote_proof_gen = function(_arg, cb) {
      var arg, esc, g, klass, remote_name_normalized, sig_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      klass = _arg.klass, remote_name_normalized = _arg.remote_name_normalized, sig_id = _arg.sig_id;
