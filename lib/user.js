      ...
      (function(__iced_k) {
        if ((last = _this.sig_chain.last()) != null) {
          ...
          (function(__iced_k) {
            ...
            return __iced_k(err != null ? err = new E.VerifyError("" + (_this.username()) + ": failed to verify signature") : (m = stderr.data().toString('utf8').match(/Primary key fingerprint: (.*)/)) == null ? (console.log(stderr.data().toString('utf8')), err = new E.VerifyError("" + (_this.username()) + ": can't parse PGP output in verify signature")) : (a = strip(m[1]).toLowerCase()) !== (b = last.fingerprint()) ? err = new E.VerifyError("" + (_this.username()) + ": bad key: " + a + " != " + b) : (a = out.toString('utf8')) !== (b = last.payload_json()) ? err = new E.VerifyError("" + (_this.username()) + ": payload was wrong: " + a + " != " + b) : void 0);
          });
        } else {
          return __iced_k();
        }
