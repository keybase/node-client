...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, env, format_fingerprint, iced, log, make_email, make_esc, proofs, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  _ref2 = process.platform === 'win32' ? ["ok", "BAD"] : ["\u2714", "\u2716"], CHECK = _ref2[0], BAD_X = _ref2[1];
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.remote_username = function() {
      var _ref3, _ref4, _ref5;
      return (_ref3 = this.payload_json()) != null ? (_ref4 = _ref3.body) != null ? (_ref5 = _ref4.service) != null ? _ref5.username : void 0 : void 0 : void 0;
    };
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.get_track_obj = function(uid) {
      var _ref3, _ref4;
      return (_ref3 = this.table[ST.TRACK]) != null ? (_ref4 = _ref3[uid]) != null ? _ref4.to_table_obj() : void 0 : void 0;
    };
