...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, env, format_fingerprint, iced, log, make_email, make_esc, proofs, proxyca, req, request, scraper, strip, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.get_sub_id = function() {
      var _ref3;
      return (_ref3 = scraper.alloc_stub(this.proof_type())) != null ? _ref3.get_sub_id(this.proof_service_object()) : void 0;
    };

    Link.prototype.to_list_display = function() {
      var _ref3;
      return (_ref3 = scraper.alloc_stub(this.proof_type())) != null ? _ref3.to_list_display(this.proof_service_object()) : void 0;
    };
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.list_remote_proofs = function() {
      var display_obj, k, obj, out, tab, type, v;
      out = null;
      display_obj = function(out, k, v) {
        var k2, v2, _results;
        if (v instanceof Link) {
          return out[k] = v.to_list_display();
        } else {
          _results = [];
          for (k2 in v) {
            v2 = v[k2];
            ...
            _results.push(display_obj(out[k], k2, v2));
          }
          return _results;
        }
      };
