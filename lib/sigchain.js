...
(function() {
  var ACCTYPES, BTC, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, athrow, bitcoyne, cheerio, colors, constants, date_to_unix, db, deq, dict_union, env, format_fingerprint, iced, log, make_email, make_esc, merkle_client, proofs, req, request, scrapemod, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._compress = function(_arg) {
      var INSERT, MAKE, S, body, err, id, index, keys, link, lt, out, pjs, prune, show_perm_failures, sig_id, states, sub_id, version, _i, _len, _ref10, _ref11, _ref12, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        switch (lt) {
          ...
          case ST.REMOTE_PROOF:
            ...
            if (show_perm_failures) {
              states.push(S.PERM_FAILURE);
            }
            if (_ref5 = link.proof_state(), __indexOf.call(states, _ref5) >= 0) {
          ...
          case ST.CRYPTOCURRENCY:
            if ((id = body != null ? (_ref7 = body.cryptocurrency) != null ? _ref7.address : void 0 : void 0) == null) {
              log.warn("Missing Cryptocurrency address");
              log.debug("Full JSON in signature:");
              log.debug(pjs);
            } else if ((_ref8 = bitcoyne.address.check(id, {
              version: ACCTYPES
            }), err = _ref8[0], (_ref9 = _ref8[1], version = _ref9.version), _ref8) == null) {
              log.error("Error in checking cryptocurrency address: " + id);
            } else if (err != null) {
              log.warn("Error in cryptocurrency address: " + err.message);
            } else {
              MAKE(out, lt, {})[version] = link;
            }
            break;
          case ST.REVOKE:
            if (!(sig_id = body != null ? (_ref10 = body.revoke) != null ? _ref10.sig_id : void 0 : void 0)) {
            ...
            break;
          case ST.UNTRACK:
            if ((id = body != null ? (_ref11 = body.untrack) != null ? _ref11.id : void 0 : void 0) == null) {
              log.warn("Mssing untrack in signature: " + pjs);
            } else if ((link = (_ref12 = out[ST.TRACK]) != null ? _ref12[id] : void 0) == null) {
    ...
    SigChain.prototype.list_cryptocurrency_addresses = function(opts) {
      ...
      if ((this.table != null) && ((tab = this.table[ST.CRYPTOCURRENCY]) != null)) {
        out = {};
        for (k in tab) {
          v = tab[k];
    ...
    SigChain.prototype.display_cryptocurrency_addresses = function(opts, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if ((tab = _this.table[ST.CRYPTOCURRENCY]) != null) {
            (function(__iced_k) {
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      var assertions, esc, k, link, links, msg, n, pubkey, skip, tab, type, username, v, v2, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3, _ref4;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      if (assertions != null) {
        if ((_ref4 = assertions.found('keybase', false)) != null) {
          _ref4.success().set_payload(username);
        }
      }
      (function(_this) {
        return (function(__iced_k) {
          var _ref5;
          if ((tab = (_ref5 = _this.table) != null ? _ref5[ST.REMOTE_PROOF] : void 0) != null) {
