...
(function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.verify_sig = function(_arg, cb) {
      var eldest_kid, esc, key, last_lkb_link, link, lkb_chain_link, lkb_sig_chain, merkle_data, opts, parsed_keys, seqnos, sig_blobs, verified_links, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      var assertions, esc, link, links, msg, n, proof_vec, pubkey, skip, tab, type, v, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
