...
(function() {
  var BAD_X, BufferOutStream, CHECK, E, Link, SHA256, ST, SigChain, Warnings, assert_no_collision, asyncify, cheerio, colors, constants, date_to_unix, db, deq, gpg, iced, log, make_email, make_esc, proofs, read_uids_from_key, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  _ref1 = require('gpg-wrapper'), BufferOutStream = _ref1.BufferOutStream, assert_no_collision = _ref1.assert_no_collision, gpg = _ref1.gpg, read_uids_from_key = _ref1.read_uids_from_key;

  _ref2 = require('./util'), date_to_unix = _ref2.date_to_unix, make_email = _ref2.make_email;
  ...
  exports.Link = Link = (function() {
        ...
        return (function(__iced_k) {
          if ((_this.sig_type() === ST.REMOTE_PROOF) && (_this.api_url() == null)) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                var _ref3;
                if ((typeof err === "undefined" || err === null) && ((row = (_ref3 = u.body) != null ? _ref3.row : void 0) != null) && ((u = row.api_url) != null)) {
    ...
    Link.prototype.verify_sig = function(_arg, cb) {
      var a, args, b, em, err, m, out, pubkey, stderr, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Link.prototype.check_remote_proof = function(_arg, cb) {
      var e2, err, esc, msg, ok, rc, remote_username, scraper, skip, type, type_s, username, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      skip = _arg.skip, username = _arg.username, type = _arg.type, warnings = _arg.warnings;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              var _ref3, _ref4, _ref5;
              if ((remote_username = (_ref3 = _this.payload_json()) != null ? (_ref4 = _ref3.body) != null ? (_ref5 = _ref4.service) != null ? _ref5.username : void 0 : void 0 : void 0) == null) {
  ...
  exports.SigChain = SigChain = (function() {
        ...
        return (function(__iced_k) {
          if (((a = remote_seqno) == null) || a > (b = _this.last_seqno())) {
            ...
            (function(__iced_k) {
              ...
              if ((remote_seqno != null) && ((a = remote_seqno) !== (b = _this.last_seqno()))) {
                err = new E.CorruptionError("failed to appropriately update chain: " + a + " != " + b);
              }
              return __iced_k(did_update = true);
            });
          } else {
            return __iced_k();
          }
    ...
    SigChain.prototype._verify_userid = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if (!found) {
            _ref3 = [ST.REMOTE_PROOF, ST.TRACK];
    ...
    SigChain.prototype._compress = function() {
      var MAKE, body, id, index, link, lt, out, pjs, prune, sig_id, _i, _len, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        switch (lt) {
          ...
          case ST.REMOTE_PROOF:
            ...
            break;
          case ST.TRACK:
            if ((id = body != null ? (_ref5 = body.track) != null ? _ref5.id : void 0 : void 0) == null) {
            ...
            break;
          case ST.REVOKE:
            if (!(sig_id = body != null ? (_ref6 = body.revoke) != null ? _ref6.sig_id : void 0 : void 0)) {
            ...
            break;
          case ST.UNTRACK:
            if ((id = body != null ? (_ref7 = body.untrack) != null ? _ref7.id : void 0 : void 0) == null) {
              log.warn("Mssing untrack in signature: " + pjs);
            } else if ((link = (_ref8 = out[ST.TRACK]) != null ? _ref8[id] : void 0) == null) {
              log.warn("Unexpected untrack of " + id + " in signature chain");
            } else if (link.is_revoked()) {
              log.warn("Tracking was already revoked for " + id + " (ignoring untrack)");
            } else {
              link.revoke();
            }
            break;
    ...
    SigChain.prototype.get_track_obj = function(uid) {
      var _ref3, _ref4, _ref5;
      return (_ref3 = this.table[ST.TRACK]) != null ? (_ref4 = _ref3[uid]) != null ? (_ref5 = _ref4.body()) != null ? _ref5.track : void 0 : void 0 : void 0;
    };

    SigChain.prototype.verify_sig = function(_arg, cb) {
      var esc, pubkey, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, pubkey = _arg.pubkey;
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref3;
          if ((_this.fingerprint = (_ref3 = _this.last()) != null ? _ref3.fingerprint() : void 0) != null) {
            _this._limit();
            _this._compress();
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      var esc, link, skip, tab, type, username, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      skip = _arg.skip, username = _arg.username;
