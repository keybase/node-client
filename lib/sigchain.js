...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, env, format_fingerprint, iced, log, make_email, make_esc, proofs, proxyca, req, request, scraper, strip, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3;
  ...
  _ref3 = process.platform === 'win32' ? ["ok", "BAD"] : ["\u2714", "\u2716"], CHECK = _ref3[0], BAD_X = _ref3[1];
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.is_self_sig = function() {
      var _ref4;
      return (_ref4 = this.sig_type()) === ST.SELF_SIG || _ref4 === ST.REMOTE_PROOF || _ref4 === ST.TRACK;
    };

    Link.prototype.self_signer = function() {
      var _ref4, _ref5, _ref6;
      return (_ref4 = this.payload_json()) != null ? (_ref5 = _ref4.body) != null ? (_ref6 = _ref5.key) != null ? _ref6.username : void 0 : void 0 : void 0;
    };

    Link.prototype.proof_service_object = function() {
      var _ref4, _ref5;
      return (_ref4 = this.payload_json()) != null ? (_ref5 = _ref4.body) != null ? _ref5.service : void 0 : void 0;
    };

    Link.prototype.remote_username = function() {
      var _ref4;
      return (_ref4 = this.proof_service_object()) != null ? _ref4.username : void 0;
    };
    ...
    Link.prototype.body = function() {
      var _ref4;
      return (_ref4 = this.payload_json()) != null ? _ref4.body : void 0;
    };
    ...
    Link.prototype.store = function(cb) {
      var err, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (((_ref4 = this.obj.prev) != null ? _ref4.length : void 0) === 0) {
        this.obj.prev = null;
      }
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    if (!_this.api_url()) {
                      ...
                      (function(__iced_k) {
                        ...
                        scraper.alloc(type, esc(__iced_deferrals.defer({
                          assign_fn: (function() {
                            return function() {
                ...
                msg = scraper.make_message(ok, _this.human_url());
                msg = [(ok ? CHECK : BAD_X), '"' + ((ok ? colors.green : colors.red)(display)) + '"', "on", type_s + ":", _this.human_url()];
                if (skip) {
    ...
    Link.prototype.remote_proof_to_track_obj = function() {
      ...
      return {
        ...
        remote_key_proof: {
          check_data_json: (_ref4 = this.payload_json()) != null ? (_ref5 = _ref4.body) != null ? _ref5.service : void 0 : void 0,
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._verify_userid = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _i, _j, _len, _len1, _ref4, _ref5, _ref6;
          found = ((function() {
          ...
          if (!found && ((v = (_ref4 = _this.table) != null ? _ref4[ST.SELF_SIG] : void 0) != null)) {
          ...
          if (!found) {
            ...
            for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
              type = _ref5[_j];
              if ((d = (_ref6 = _this.table) != null ? _ref6[type] : void 0)) {
                for (k in d) {
                  link = d[k];
                  if (link.self_signer() === _this.username) {
                    found = true;
    ...
    SigChain.prototype._compress = function() {
      var MAKE, S, body, id, index, link, lt, out, pjs, prune, sig_id, _i, _len, _ref10, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        ...
        body = (_ref5 = link.payload_json()) != null ? _ref5.body : void 0;
        ...
        switch (lt) {
          ...
          case ST.REMOTE_PROOF:
            ...
            if ((_ref6 = link.proof_state()) === S.OK || _ref6 === S.TEMP_FAILURE || _ref6 === S.LOOKING) {
              MAKE(out, lt, {})[link.proof_type()] = link;
            }
            break;
          case ST.TRACK:
            if ((id = body != null ? (_ref7 = body.track) != null ? _ref7.id : void 0 : void 0) == null) {
            ...
            break;
          case ST.REVOKE:
            if (!(sig_id = body != null ? (_ref8 = body.revoke) != null ? _ref8.sig_id : void 0 : void 0)) {
            ...
            break;
          case ST.UNTRACK:
            if ((id = body != null ? (_ref9 = body.untrack) != null ? _ref9.id : void 0 : void 0) == null) {
              log.warn("Mssing untrack in signature: " + pjs);
            } else if ((link = (_ref10 = out[ST.TRACK]) != null ? _ref10[id] : void 0) == null) {
    ...
    SigChain.prototype.remote_proofs_to_track_obj = function() {
      var d, key, link, _ref4, _results;
      if ((d = (_ref4 = this.table) != null ? _ref4[ST.REMOTE_PROOF] : void 0) != null) {
        _results = [];
        for (key in d) {
          link = d[key];
          if (!link.is_revoked()) {
    ...
    SigChain.prototype.get_track_obj = function(uid) {
      var _ref4, _ref5, _ref6;
      return (_ref4 = this.table) != null ? (_ref5 = _ref4[ST.TRACK]) != null ? (_ref6 = _ref5[uid]) != null ? _ref6.to_table_obj() : void 0 : void 0 : void 0;
    };
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      var assertions, esc, link, msg, n, pubkey, skip, tab, type, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
