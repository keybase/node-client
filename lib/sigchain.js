...
(function() {
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.check_remote_proof = function(_arg, cb) {
      var e2, err, esc, msg, ok, pubkey, rc, remote_username, scraper, skip, type, type_s, username, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      skip = _arg.skip, pubkey = _arg.pubkey, type = _arg.type, warnings = _arg.warnings;
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      var esc, link, pubkey, skip, tab, type, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      skip = _arg.skip, pubkey = _arg.pubkey;
