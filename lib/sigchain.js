  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._verify_userid = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _i, _j, _len, _len1, _ref5, _ref6, _ref7, _ref8;
          found = ((function() {
          ...
          if (!found && ((link = (_ref5 = _this.table) != null ? _ref5.get(ST.SELF_SIG) : void 0) != null) && (link.self_signer() === _this.username)) {
            found = true;
          }
          log.debug("- found -> " + found);
          log.debug("+ search for a free-rider on a track signature (found=" + found + ")");
          if (!found) {
            _ref6 = [ST.REMOTE_PROOF, ST.TRACK];
            for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
              type = _ref6[_i];
              tab = ((_ref7 = _this.table) != null ? (_ref8 = _ref7.get(type)) != null ? _ref8.flatten() : void 0 : void 0) || [];
