      ...
      (function(_this) {
        ...
        return function() {
          ...
          if ((typeof err === "undefined" || err === null) && !found) {
            msg = _this.username === env().get_username() ? "You haven't signed your own key! Add '" + kbem + "' to your key with GPG and then `keybase push --update`" : "user '" + _this.username + "' hasn't signed their own key";
