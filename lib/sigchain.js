...
(function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.check_merkle_tree = function(cb) {
      var a, b, err, merkle_root, payload_hash, seqno, val, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
        ...
        return function() {
          err = err != null ? err : typeof val === "undefined" || val === null ? new E.NotFoundError("No value " + _this.uid + " found in merkle tree") : !Array.isArray(val) || val.length < 2 ? new E.BadValueError("expected an array of length 2 or more") : ((seqno = val[0], payload_hash = val[1], val), console.log(_this.true_last()), (a = seqno) !== (b = _this.true_last().seqno()) ? new E.BadSeqnoError("bad sequence in root: " + a + " != " + b) : (a = payload_hash) !== (b = _this.true_last().id) ? new E.BadPayloadHash("bad payload hash in root: " + a + " != " + b) : (_this._merkle_root = merkle_root, null));
          return cb(err);
        };
      })(this));
    };
