...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, env, format_fingerprint, iced, log, make_email, make_esc, proofs, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.is_track_fresh = function(id) {
      var l, _i, _ref2, _ref3;
      _ref2 = this._links;
      for (_i = _ref2.length - 1; _i >= 0; _i += -1) {
        l = _ref2[_i];
        if (l.id === id) {
          return true;
        } else if (!((_ref3 = l.sig_type()) === ST.TRACK || _ref3 === ST.UNTRACK)) {
          return false;
        }
      }
      return false;
    ...
    SigChain.prototype._limit = function() {
      ...
      for (i = _i = _ref2 = this._links.length - 1; _ref2 <= 0 ? _i <= 0 : _i >= 0; i = _ref2 <= 0 ? ++_i : --_i) {
        if (((_ref3 = (l = this._links[i]).fingerprint()) != null ? _ref3.toLowerCase() : void 0) === this.fingerprint) {
          c.push(l);
        } else {
          break;
        }
    ...
    SigChain.prototype._verify_userid = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _i, _j, _len, _len1, _ref2, _ref3, _ref4;
          found = ((function() {
          ...
          if (!found && ((v = (_ref2 = _this.table) != null ? _ref2[ST.SELF_SIG] : void 0) != null)) {
          ...
          if (!found) {
            ...
            for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
              type = _ref3[_j];
              if ((d = (_ref4 = _this.table) != null ? _ref4[type] : void 0)) {
                for (k in d) {
                  link = d[k];
                  if (link.self_signer() === _this.username) {
                    found = true;
    ...
    SigChain.prototype.remote_proofs_to_track_obj = function() {
      var d, key, link, _ref2, _results;
      if ((d = (_ref2 = this.table) != null ? _ref2[ST.REMOTE_PROOF] : void 0) != null) {
        _results = [];
        for (key in d) {
          link = d[key];
          if (!link.is_revoked()) {
    ...
    SigChain.prototype.verify_sig = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref2, _ref3;
          if (((_this.fingerprint = (_ref2 = key.fingerprint()) != null ? _ref2.toLowerCase() : void 0) != null) && (((_ref3 = _this.last()) != null ? _ref3.fingerprint() : void 0) != null)) {
            ...
            return __iced_k(log.debug("| Skipped since no fingerprint found in key or an empty chain"));
          }
        });
      })(this)((function(_this) {
        return function() {
    ...
    SigChain.prototype.check_remote_proofs = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref2;
          if ((tab = (_ref2 = _this.table) != null ? _ref2[ST.REMOTE_PROOF] : void 0) != null) {
