...
(function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._verify_userid = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if (!found && ((link = (_ref4 = _this.table) != null ? _ref4.get(ST.SELF_SIG) : void 0) != null) && (link.self_signer() === _this.username)) {
            found = true;
          }
          log.debug("- found -> " + found);
          ...
          if (!found) {
            ...
            for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
              type = _ref5[_i];
              tab = ((_ref6 = _this.table) != null ? (_ref7 = _ref6.get(type)) != null ? _ref7.flatten() : void 0 : void 0) || [];
    ...
    SigChain.prototype._compress = function(opts) {
      var index, link, out, seq, _i, _len, _ref4;
    ...
    SigChain.prototype.list_remote_proofs = function(opts) {
      var k, obj, out, tab, type, v, _ref4, _ref5;
      if (opts == null) {
        opts = {};
      }
      out = null;
      if ((tab = (_ref4 = this.table) != null ? (_ref5 = _ref4.get(ST.REMOTE_PROOF)) != null ? _ref5.to_dict() : void 0 : void 0) != null) {
        for (type in tab) {
          obj = tab[type];
        ...
        return (function(__iced_k) {
          if (lst != null) {
            (function(__iced_k) {
              ...
              var _ref4;
              return __iced_k(err == null ? ((_ref4 = val.get_public(), seqno = _ref4.seqno, payload_hash = _ref4.payload_hash, _ref4), (a = seqno) !== (b = lst.seqno()) ? err = new E.BadSeqnoError("bad sequence in root: " + a + " != " + b) : (a = payload_hash) !== (b = lst.id) ? err = new E.BadPayloadHash("bad payload hash in root: " + a + " != " + b) : _this._merkle_root = merkle_root) : void 0);
            });
          } else {
