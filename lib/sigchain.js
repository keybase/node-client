...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, env, format_fingerprint, iced, log, make_email, make_esc, proofs, proxyca, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.alloc_scraper = function(type, cb) {
      var PT, err, klass, scraper, _ref3;
      ...
      if (!klass) {
        ...
        scraper = new klass({
          ...
          log_level: 'debug',
          proxy: env().get_proxy(),
          ca: (_ref3 = proxyca.get()) != null ? _ref3.data() : void 0
        });
      }
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._compress = function() {
      var MAKE, S, body, id, index, link, lt, out, pjs, prune, sig_id, _i, _len, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    SigChain.prototype.list_trackees = function() {
      var out, tab;
      out = [];
      if ((typeof table !== "undefined" && table !== null) && ((tab = this.table[ST.TRACK]) != null)) {
        console.log(tab);
      }
      return out;
    };
