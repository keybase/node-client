...
(function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._compress = function() {
      var MAKE, body, cat, id, index, link, lt, out, pjs, sig, sig_id, _i, _len, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        switch (lt) {
          ...
          case ST.UNTRACK:
            ...
            } else if (!(((_ref8 = out[ST.TRACK]) != null ? _ref8[id] : void 0) != null)) {
              log.warn("Not tracking " + id + " to begin with");
            } else {
              delete out[ST.TRACK][id];
            }
            console.log("untrack for " + id);
            break;
          default:
