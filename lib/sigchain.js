...
(function() {
  var BufferOutStream, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, constants, db, gpg, iced, log, make_email, make_esc, proofs, read_uids_from_key, req, request, strip, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  _ref1 = require('./gpg'), gpg = _ref1.gpg, read_uids_from_key = _ref1.read_uids_from_key;
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.verify_sig = function(_arg, cb) {
      var a, args, b, err, m, out, stderr, which, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      which = _arg.which;
    ...
    Link.prototype.check_remote_proof = function(_arg, cb) {
      var err, esc, rc, remote_username, scraper, type, type_s, username, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
              ...
              if ((remote_username = (_ref2 = _this.payload_json()) != null ? (_ref3 = _ref2.body) != null ? (_ref4 = _ref3.service) != null ? _ref4.username : void 0 : void 0 : void 0) == null) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    return __iced_k(rc !== proofs.constants.v_codes.OK ? (console.log("remote id -> "), console.log(_this.remote_id()), console.log(_this.api_url()), err = new E.RemoteCheckError("Remote check failed (code: " + rc + ")")) : void 0);
                  });
                });
              }
            })(__iced_k);
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        switch (lt) {
          ...
          case ST.REVOKE:
            ...
            break;
          case ST.UNFOLLOW:
            if (!(id = (body != null ? (_ref6 = body.tracl) != null ? _ref6.id : void 0 : void 0) != null)) {
