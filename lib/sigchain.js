...
(function() {
  var BAD_X, BufferOutStream, CHECK, E, Link, SHA256, ST, SigChain, Warnings, assert_no_collision, asyncify, cheerio, colors, constants, date_to_unix, db, deq, gpg, iced, log, make_email, make_esc, proofs, read_uids_from_key, req, request, strip, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        switch (lt) {
          ...
          case ST.REMOTE_PROOF:
            ...
            break;
          case ST.TRACK:
            if (!(id = body != null ? (_ref5 = body.track) != null ? _ref5.id : void 0 : void 0)) {
