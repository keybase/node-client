...
(function() {
  var BAD_X, BufferOutStream, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, constants, db, gpg, iced, log, make_email, make_esc, proofs, read_uids_from_key, req, request, strip, __iced_k, __iced_k_noop, _ref, _ref1;
              ...
              if ((remote_username = (_ref2 = _this.payload_json()) != null ? (_ref3 = _ref2.body) != null ? (_ref4 = _ref3.service) != null ? _ref4.username : void 0 : void 0 : void 0) == null) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    return __iced_k(rc !== proofs.constants.v_codes.OK ? err = new E.RemoteCheckError("Remote check failed (code: " + rc + ")") : log.debug("| proof checked out"));
                  });
                });
              }
            })(function() {
