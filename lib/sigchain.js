...
(function() {
  var BAD_X, BufferOutStream, CHECK, E, Link, SHA256, ST, SigChain, Warnings, assert_no_collision, asyncify, cheerio, colors, constants, date_to_unix, db, deq, iced, log, make_email, make_esc, proofs, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  assert_no_collision = require('./gpg').assert_no_collision;
                      ...
                      (function(__iced_k) {
                        if ((a = strip(m[1])) !== (b = _this.short_key_id())) {
                          ...
                          (function(__iced_k) {
                            ...
                            pubkey.assert_no_collision(b, __iced_deferrals.defer({
                              assign_fn: (function() {
                                return function() {
                                  return err = arguments[0];
                                };
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype.get_track_obj = function(uid) {
      var _ref2, _ref3, _ref4;
      return (_ref2 = this.table[ST.TRACK]) != null ? (_ref3 = _ref2[uid]) != null ? (_ref4 = _ref3.body()) != null ? _ref4.track : void 0 : void 0 : void 0;
    };
