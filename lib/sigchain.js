...
(function() {
  var BAD_X, CHECK, E, Link, SHA256, ST, SigChain, Warnings, asyncify, cheerio, colors, constants, date_to_unix, db, deq, format_fingerprint, iced, log, make_email, make_esc, proofs, req, request, strip, util, __iced_k, __iced_k_noop, _ref, _ref1;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if ((typeof err === "undefined" || err === null) && !found) {
            err = new E.VerifyError("user '" + _this.username + "' hasn't signed their own key");
          }
