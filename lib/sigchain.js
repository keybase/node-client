...
(function() {
  ...
  exports.Link = Link = (function() {
    ...
    Link.prototype.check_remote_proof = function(_arg, cb) {
      var arg, assert, assertions, display, e2, err, esc, msg, ok, pubkey, rc, rsc, scraper, skip, type, type_s, username, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
