...
(function() {
  var Config, fs, iced, log, mkdirp, path, purge, util, __iced_k, __iced_k_noop;
        ...
        return function() {
          (function(__iced_k) {
            if (_this.found) {
              ...
              return __iced_k(!_this.opts.quiet ? (log.warn("No config file found; tried '" + _this.filename + "'"), log.warn("Run 'keybase config' to make a new config file")) : void 0);
            }
          })(function() {
            return cb(err);
          });
          ...
          if (_this.changed) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k(err == null ? log.info("Updated file: " + _this.filename) : void 0);
              });
            });
          } else {
            return __iced_k();
