...
(function() {
  var AnnouncementSigGen, BaseSigGen, BitbucketProofGen, CoinbaseProofGen, CryptocurrencySigGen, DnsProofGen, E, GenericWebSiteProofGen, GithubProofGen, HackerNewsProofGen, KeybaseProofGen, KeybasePushProofGen, RedditProofGen, RevokeProofSigGen, SignatureEngine, SocialNetworkProofGen, TrackerProofGen, TwitterProofGen, UntrackerProofGen, colors, constants, decode, env, iced, log, make_esc, master_ring, proofs, req, scrapers, session, strip_at, url_reencode, urlmod, __iced_k, __iced_k_noop,
  ...
  exports.BitbucketProofGen = BitbucketProofGen = (function(_super) {
    __extends(BitbucketProofGen, _super);

    function BitbucketProofGen() {
      return BitbucketProofGen.__super__.constructor.apply(this, arguments);
    }

    BitbucketProofGen.prototype._binding_klass = function() {
      return proofs.BitbucketBinding;
    };

    BitbucketProofGen.prototype._remote_service_name = function() {
      return "bitbucket";
    };

    BitbucketProofGen.prototype.imperative_verb = function() {
      return "post a snippet with";
    };

    BitbucketProofGen.prototype.display_name = function() {
      return "Bitbucket";
    };

    BitbucketProofGen.prototype.instructions = function() {
      return "Please " + (colors.bold('publicly')) + " post the following snippet, and name the file " + (colors.bold(colors.red('keybase.md'))) + ":";
    };

    BitbucketProofGen.prototype.make_retry_msg = function(status) {
      switch (status) {
        case proofs.constants.v_codes.PERMISSION_DENIED:
          return "Permission denied! Make sure your snippet is public";
        default:
          return BitbucketProofGen.__super__.make_retry_msg.call(this);
      }
    };

    return BitbucketProofGen;
