...
(function() {
  var BaseSigGen, KeybaseProofGen, KeybasePushProofGen, RemoteServiceProofGen, SignatureEngine, TrackerProofGen, TwitterProofGen, UntrackerProofGen, constants, decode, env, iced, log, make_esc, master_ring, proofs, req, session, __iced_k, __iced_k_noop,
  ...
  exports.GithubProofGen = TwitterProofGen = (function(_super) {
    __extends(TwitterProofGen, _super);
