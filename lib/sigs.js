...
(function() {
  var BaseSigGen, GithubProofGen, KeybaseProofGen, KeybasePushProofGen, RemoteServiceProofGen, SignatureEngine, TrackerProofGen, TwitterProofGen, UntrackerProofGen, colors, constants, decode, env, iced, log, make_esc, master_ring, proofs, req, session, __iced_k, __iced_k_noop,
  ...
  RemoteServiceProofGen = (function(_super) {
    __extends(RemoteServiceProofGen, _super);

    function RemoteServiceProofGen(args) {
      this.remote_username = args.remote_username;
      RemoteServiceProofGen.__super__.constructor.call(this, args);
    }

    RemoteServiceProofGen.prototype._make_binding_eng = function(args) {
      var klass;
    ...
    RemoteServiceProofGen.prototype._v_modify_store_arg = function(arg) {
      arg.remote_username = this.remote_username;
      return arg.type = "web_service_binding." + this._remote_service_name();
    };

    return RemoteServiceProofGen;

  })(BaseSigGen);

  exports.GenericWebSiteProofGen = BaseSigGen = (function() {
    function BaseSigGen(args) {
      this.remote_host = args.remote_host;
      BaseSigGen.__super__.constructor.call(this, args);
    }

    BaseSigGen.prototype._make_binding_eng = function(args) {
      args.remote_host = this.remote_host;
      return new proofs.GenericWebSiteBinding(args);
    };
    ...
    BaseSigGen.prototype.instructions = function() {
      var file;
