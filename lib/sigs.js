...
(function() {
  var AnnouncementSigGen, BaseSigGen, CoinbaseProofGen, CryptocurrencySigGen, DnsProofGen, E, GenericWebSiteProofGen, GithubProofGen, KeybaseProofGen, KeybasePushProofGen, RedditProofGen, RevokeProofSigGen, SignatureEngine, SocialNetworkProofGen, TrackerProofGen, TwitterProofGen, UntrackerProofGen, colors, constants, decode, env, iced, log, make_esc, master_ring, proofs, req, session, strip_at, urlmod, __iced_k, __iced_k_noop,
  ...
  BaseSigGen = (function() {
    function BaseSigGen(_arg) {
      this.km = _arg.km, this.client = _arg.client, this.supersede = _arg.supersede, this.merkle_root = _arg.merkle_root, this.revoke_sig_ids = _arg.revoke_sig_ids;
    }
  ...
  exports.CryptocurrencySigGen = CryptocurrencySigGen = (function(_super) {
    ...
    function CryptocurrencySigGen(_arg) {
      var client, km, merkle_root, revoke_sig_ids;
      km = _arg.km, this.cryptocurrency = _arg.cryptocurrency, revoke_sig_ids = _arg.revoke_sig_ids, client = _arg.client, merkle_root = _arg.merkle_root;
      CryptocurrencySigGen.__super__.constructor.call(this, {
        km: km,
        client: client,
        merkle_root: merkle_root,
        revoke_sig_ids: revoke_sig_ids
      });
    }
  ...
  exports.AnnouncementSigGen = AnnouncementSigGen = (function(_super) {
    ...
    function AnnouncementSigGen(_arg) {
      var client, km, merkle_root, revoke_sig_ids;
      km = _arg.km, this.announcement = _arg.announcement, revoke_sig_ids = _arg.revoke_sig_ids, client = _arg.client, merkle_root = _arg.merkle_root;
      AnnouncementSigGen.__super__.constructor.call(this, {
        km: km,
        client: client,
        merkle_root: merkle_root,
        revoke_sig_ids: revoke_sig_ids
  ...
  exports.RedditProofGen = RedditProofGen = (function(_super) {
    ...
    RedditProofGen.prototype.show_proof_text = function() {
      ...
      return url = url.replace(/%20/g, '+').replace(/[()']/g, function(c) {
  ...
  exports.CoinbaseProofGen = CoinbaseProofGen = (function(_super) {
    ...
    CoinbaseProofGen.prototype.instructions = function() {
      return "Please update your coinbase profile HERE to show this proof";
    };
