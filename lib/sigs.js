...
(function() {
  var BaseSigGen, KeybaseProofGen, KeybasePushProofGen, SignatureEngine, constants, env, iced, make_esc, proofs, req, session, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  BaseSigGen = (function() {
    ...
    BaseSigGen.prototype._store_signature = function(cb) {
      ...
      (function(__iced_k) {
        ...
        req.post({
          endpoint: _this._get_api_endpoint(),
          args: args
        }, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
