...
(function() {
  ...
  exports.CryptocurrencyProofGen = CryptocurrencyProofGen = (function(_super) {
    __extends(CryptocurrencyProofGen, _super);

    function CryptocurrencyProofGen(_arg) {
      ...
      CryptocurrencyProofGen.__super__.constructor.call(this, {
        km: km,
        client: client,
    ...
    CryptocurrencyProofGen.prototype._make_binding_eng = function(arg) {
      arg.cryptocurrency = this.cryptocurrency;
      return new proofs.Cryptocurrency(arg);
    };

    CryptocurrencyProofGen.prototype._v_modify_store_arg = function(arg) {
      return arg.type = "cryptocurrency";
    };

    return CryptocurrencyProofGen;
