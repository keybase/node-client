...
(function() {
  var BaseSigGen, KeybaseProofGen, KeybasePushProofGen, SignatureEngine, TrackerProofGen, UntrackerProofGen, constants, env, iced, log, make_esc, proofs, req, session, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.UntrackerProofGen = UntrackerProofGen = (function(_super) {
    ...
    function UntrackerProofGen(_arg) {
      var km;
      km = _arg.km, this.uid = _arg.uid, this.untrack = _arg.untrack;
