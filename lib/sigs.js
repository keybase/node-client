...
(function() {
  var BaseSigGen, E, GenericWebSiteProofGen, GithubProofGen, KeybaseProofGen, KeybasePushProofGen, RevokeProofSigGen, SignatureEngine, SocialNetworkProofGen, TrackerProofGen, TwitterProofGen, UntrackerProofGen, colors, constants, decode, env, iced, log, make_esc, master_ring, proofs, req, session, strip_at, urlmod, __iced_k, __iced_k_noop,
  ...
  BaseSigGen = (function() {
    function BaseSigGen(_arg) {
      this.km = _arg.km, this.client = _arg.client;
    }
  ...
  exports.TrackerProofGen = TrackerProofGen = (function(_super) {
    ...
    function TrackerProofGen(_arg) {
      var client, km;
      km = _arg.km, this.prev = _arg.prev, this.seqno = _arg.seqno, this.uid = _arg.uid, this.track = _arg.track, client = _arg.client;
  ...
  exports.UntrackerProofGen = UntrackerProofGen = (function(_super) {
    ...
    function UntrackerProofGen(_arg) {
      var client, km;
      km = _arg.km, this.uid = _arg.uid, this.untrack = _arg.untrack, this.seqno = _arg.seqno, this.prev = _arg.prev, client = _arg.client;
  ...
  exports.GenericWebSiteProofGen = GenericWebSiteProofGen = (function(_super) {
    ...
    GenericWebSiteProofGen.prototype.instructions = function() {
      return "Please save the following file as " + (colors.bold(this.filename()));
    };
    ...
    GenericWebSiteProofGen.prototype.filename = function(h) {
      var file;
      file = proofs.GenericWebSiteScraper.FILE;
      return (h || this.remote_host) + "/" + file;
    };
    ...
    GenericWebSiteProofGen.prototype.get_warnings = function(_arg) {
      var f, remote_name_normalized;
      remote_name_normalized = _arg.remote_name_normalized;
      f = this.filename(remote_name_normalized);
      return ["You'll be asked to post a file available at " + (colors.bold(f))];
    };
    ...
    GenericWebSiteProofGen.prototype.normalize_name = function(i, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (u == null) {
            return __iced_k(err = new E.ArgsError("Failed to parse " + hostname + " is a valid internet host"));
          } else {
            hostname = u.hostname;
            args = {
