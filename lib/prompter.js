...
_break()
    ...
    Prompter.prototype.read_field = function(k, _arg, cb) {
      var checker, confirm, d, defval, err, first, first_prompt, hint, isDefault, obj, ok, p, passphrase, prompt, res, res2, thrower, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      prompt = _arg.prompt, passphrase = _arg.passphrase, checker = _arg.checker, confirm = _arg.confirm, defval = _arg.defval, thrower = _arg.thrower, first_prompt = _arg.first_prompt, hint = _arg.hint;
      err = null;
      ok = false;
      first = true;
      (function(_this) {
...
_break()
  ...
  exports.prompt_remote_name = function(_arg, cb) {
    var checker, err, p, prompt, seq, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    prompt = _arg.prompt, checker = _arg.checker;
    seq = {
      name: {
        prompt: prompt,
        checker: checker
