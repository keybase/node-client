...
_break()
  ...
  exports.prompt_passphrase = function(_arg, cb) {
    var confirm, err, extra, p, prompt, seq, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    prompt = _arg.prompt, confirm = _arg.confirm, extra = _arg.extra;
    if (prompt == null) {
  ...
  exports.prompt_for_int = function(prompt, low, hi, cb) {
