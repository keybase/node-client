...
_break()
  ...
  exports.prompt_yn = function(_arg, cb) {
    ...
    ch = win ? '[y/n]' : "[" + (defval ? 'Y' : 'y') + "/" + (!defval ? 'N' : 'n') + "]";
    prompt += " " + ch + " ";
    obj = {
      prompt: prompt
    };
        ...
        _while = function(__iced_k) {
          ...
          if (!((ret == null) && (err == null))) {
            ...
            (function(__iced_k) {
              ...
              return _next(err == null ? (res = strip(res), (res.length === 0) && (defval != null) ? ret = defval : "yes".indexOf(res.toLowerCase()) >= 0 ? ret = true : "no".indexOf(res.toLowerCase()) >= 0 ? ret = false : void 0) : void 0);
            });
          }
        };
        _while(__iced_k);
  ...
  exports.prompt_passphrase = function(_arg, cb) {
    var checker, confirm, err, extra, no_leading_space, p, prompt, seq, short, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    prompt = _arg.prompt, confirm = _arg.confirm, extra = _arg.extra, short = _arg.short, no_leading_space = _arg.no_leading_space;
    if (prompt == null) {
