...
_break()
    ...
    Prompter.prototype.read_field = function(k, _arg, cb) {
      var checker, confirm, d, err, first, isDefault, obj, ok, p, passphrase, prompt, res, res2, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      prompt = _arg.prompt, passphrase = _arg.passphrase, checker = _arg.checker, confirm = _arg.confirm;
      err = null;
      ok = false;
      first = true;
      (function(__iced_k) {
