...
(function() {
  var E, GE, ST, TmpKeyRing, TrackSubSubCommand, TrackWrapper, User, athrow, chain_err, colors, constants, db, deq, env, iced, log, make_esc, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
            ...
            (function(__iced_k) {
              if (accept) {
                ...
                (function(__iced_k) {
                  ...
                  _this.them.key.commit((_ref3 = _this.me) != null ? _ref3.key : void 0, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this.them.check_remote_proofs(false, esc(__iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
    ...
    TrackSubSubCommand.prototype._run2 = function(_arg, cb) {
      var accept, esc, found_them, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
