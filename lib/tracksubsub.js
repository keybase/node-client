...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype.save_key = function(k, cb) {
      var err, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/max/src/keybase-node-client/src/tracksubsub.iced",
            funcname: "TrackSubSubCommand.save_key"
          });
    ...
    TrackSubSubCommand.prototype.run = function(cb) {
      var accept, ckres, cleanup, esc, k, sqring, tmp, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sqring = null;
      cleanup = function(cb) {
          ...
          return (function(__iced_k) {
            if (sqring != null) {
              (function(__iced_k) {
                ...
                sqring.nuke(__iced_deferrals.defer({
                  assign_fn: (function() {
                    return function() {
                ...
                return __iced_k(typeof e2 !== "undefined" && e2 !== null ? log.warning("Error deleting sequestered keyring: " + e2.message) : void 0);
              });
            } else {
              return __iced_k();
            }
                      ...
                      (function(__iced_k) {
                        if (!ckres.local) {
                          (function(__iced_k) {
                            ...
                            _this.them.make_quarantined_keyring(esc(__iced_deferrals.defer({
                              assign_fn: (function() {
                                return function() {
                    ...
                    (function(__iced_k) {
                      ...
                      (function(__iced_k) {
                        ...
                        (function(__iced_k) {
                          ...
                          (function(__iced_k) {
                            var _ref3;
                            if (accept && ((k = (_ref3 = _this.them) != null ? _ref3.key : void 0) != null) && !ckres.local) {
                              (function(__iced_k) {
                                __iced_deferrals = new iced.Deferrals(__iced_k, {
                                  parent: ___iced_passed_deferral,
                                  filename: "/home/max/src/keybase-node-client/src/tracksubsub.iced",
                                ...
                                _this.save_key(k, esc(__iced_deferrals.defer({
                                  lineno: 186
                                })));
                                __iced_deferrals._fulfill();
                              })(__iced_k);
