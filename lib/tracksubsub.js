...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype._key_cleanup = function(_arg, cb) {
      var accept, err, their_pubkey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      accept = _arg.accept, their_pubkey = _arg.their_pubkey;
      err = null;
      (function(_this) {
        return (function(__iced_k) {
          if (accept) {
            ...
            (function(__iced_k) {
              ...
              their_pubkey.commit(_this.me.pubkey, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
            ...
            (function(__iced_k) {
              ...
              their_pubkey.rollback(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
    ...
    TrackSubSubCommand.prototype.id = function(cb) {
      var accept, esc, pubkey, them, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    TrackSubSubCommand.prototype.run = function(cb) {
      var accept, err, esc, pubkey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
