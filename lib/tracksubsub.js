...
(function() {
  var E, GE, ST, TmpKeyRing, TrackSubSubCommand, TrackWrapper, User, assertions, athrow, chain_err, colors, constants, db, deq, env, iced, keypull, log, make_esc, master_ring, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  master_ring = require('gpg-wrapper').master_ring;
