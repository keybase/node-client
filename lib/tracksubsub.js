...
(function() {
  var E, GE, ST, TmpKeyRing, TrackSubSubCommand, TrackWrapper, User, athrow, colors, constants, db, deq, env, iced, log, make_esc, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    function TrackSubSubCommand(_arg) {
      this.args = _arg.args, this.opts = _arg.opts, this.tmp_keyring = _arg.tmp_keyring;
    }
    ...
    TrackSubSubCommand.prototype.prompt_ok = function(warnings, cb) {
      ...
      prompt = warnings ? (log.console.error(colors.red("Some remote proofs failed!")), "Still verify this user?") : "Are you satisfied with these proofs?";
      (function(_this) {
        ...
        return (function(__iced_k) {
          if (accept) {
            ...
            (function(__iced_k) {
              ...
              _this.them.key.commit((_ref2 = _this.me) != null ? _ref2.key : void 0, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
    ...
    TrackSubSubCommand.prototype.run = function(cb) {
      var accept, err, esc, found_them, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    TrackSubSubCommand.prototype._run2 = function(_arg, cb) {
      var accept, approve, check, do_remote, err, esc, found_them, n_warnings, skp, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      found_them = _arg.found_them;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              check = _this.trackw.skip_remote_check();
