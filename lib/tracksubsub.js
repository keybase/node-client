...
(function() {
  var E, GE, ST, TrackSubSubCommand, TrackWrapper, User, assertion, athrow, chain_err, colors, constants, db, deq, env, iced, keypull, log, make_esc, master_ring, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
    ...
    TrackSubSubCommand.prototype.parse_assertions = function(cb) {
      ...
      try {
        if ((a = this.opts.assert) != null) {
          this.assertions = assertion.parse(a);
        }
      } catch (_error) {
        e = _error;
