...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype.save_key = function(k, cb) {
      var err, nk, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          nk.save(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
    ...
    TrackSubSubCommand.prototype.run = function(cb) {
      var accept, ckres, esc, found_them, k, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
                    ...
                    (function(__iced_k) {
                      ...
                      (function(__iced_k) {
                        ...
                        (function(__iced_k) {
                          ...
                          (function(__iced_k) {
                            var _ref3;
                            if (((k = (_ref3 = _this.them) != null ? _ref3.key : void 0) != null) && accept) {
                              (function(__iced_k) {
                                __iced_deferrals = new iced.Deferrals(__iced_k, {
                                  parent: ___iced_passed_deferral,
                                  filename: "/home/max/src/keybase-node-client/src/tracksubsub.iced",
