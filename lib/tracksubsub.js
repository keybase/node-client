...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype.resolve_user_name = function(cb) {
      var err, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/node-client/src/tracksubsub.iced",
            funcname: "TrackSubSubCommand.resolve_user_name"
          });
    ...
    TrackSubSubCommand.prototype.id = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.resolve_user_name(esc(__iced_deferrals.defer({
            lineno: 139
          })));
          __iced_deferrals._fulfill();
        });
