...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype._key_cleanup = function(_arg, cb) {
      var accept, err, pubkey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      accept = _arg.accept, pubkey = _arg.pubkey;
      err = null;
      (function(_this) {
        return (function(__iced_k) {
          if (accept) {
            ...
            (function(__iced_k) {
              ...
              pubkey.commit(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
            ...
            (function(__iced_k) {
              ...
              pubkey.rollback(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
