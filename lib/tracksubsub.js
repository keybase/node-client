...
(function() {
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype._key_cleanup = function(_arg, cb) {
      var accept, err, found, them, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return (function(__iced_k) {
          if (accept) {
            ...
            (function(__iced_k) {
              ...
              them.commit_key(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
            ...
            (function(__iced_k) {
              if (!found) {
                ...
                (function(__iced_k) {
                  ...
                  them.remove_key(__iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return err = arguments[0];
                      };
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              _this.them.import_public_key(esc(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return found = arguments[0];
                  };
