...
(function() {
  var E, GE, ST, TrackSubSubCommand, TrackWrapper, User, assertions, athrow, chain_err, constants, db, deq, env, iced, keypull, log, make_esc, master_ring, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.TrackSubSubCommand = TrackSubSubCommand = (function() {
    ...
    TrackSubSubCommand.prototype.prompt_ok = function(warnings, proofs, cb) {
      ...
      them = this.args.them;
      prompt = warnings ? (log.console.error(env().make_red("Some remote proofs failed!")), "Still verify this user as " + them + "?") : proofs === 0 ? "We found an account for " + them + ", but they haven't proved their identity. Still accept them?" : "Is this the " + them + " you wanted?";
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/max/src/keybase/node-client/src/tracksubsub.iced",
    ...
    TrackSubSubCommand.prototype.qring_cleanup = function(cb) {
      var e, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          if (_this.qring != null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-client/src/tracksubsub.iced",
                funcname: "TrackSubSubCommand.qring_cleanup"
              });
              _this.qring.nuke(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
              ...
              return __iced_k(typeof e !== "undefined" && e !== null ? log.warning("Error deleting quarantied keyring: " + e.message) : void 0);
            });
          } else {
            return __iced_k();
          }
    ...
    TrackSubSubCommand.prototype.make_quarantined_keyring = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/max/src/keybase/node-client/src/tracksubsub.iced",
            funcname: "TrackSubSubCommand.make_quarantined_keyring"
          });
          _this.them.make_quarantined_keyring(__iced_deferrals.defer({
            assign_fn: (function(__slot_1) {
              return function() {
                err = arguments[0];
                return __slot_1.qring = arguments[1];
              };
            })(_this),
            lineno: 122
          }));
    ...
    TrackSubSubCommand.prototype.id = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      cb = chain_err(cb, this.qring_cleanup.bind(this));
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.make_quarantined_keyring(esc(__iced_deferrals.defer({
              lineno: 133
            })));
            __iced_deferrals._fulfill();
          })(function() {
    ...
    TrackSubSubCommand.prototype.keypull = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (!_this.ran_keypull && !_this.skip_keypull) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-client/src/tracksubsub.iced",
    ...
    TrackSubSubCommand.prototype.save_their_key = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref3;
          if ((k = (_ref3 = _this.them) != null ? _ref3.key : void 0) != null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-client/src/tracksubsub.iced",
                funcname: "TrackSubSubCommand.save_their_key"
              });
              k.copy_to_keyring(master_ring()).save(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
                          ...
                          (function(__iced_k) {
                            if (accept && !ckres.local) {
                              (function(__iced_k) {
                                ...
                                _this.save_their_key(esc(__iced_deferrals.defer({
                                  lineno: 213
                                })));
                                __iced_deferrals._fulfill();
                              })(__iced_k);
