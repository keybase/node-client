...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.req = function(_arg, cb) {
      var args, body, cookie, endpoint, err, http_status, kb_status, method, opts, res, uri_fields, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      method = _arg.method, endpoint = _arg.endpoint, args = _arg.args, http_status = _arg.http_status, kb_status = _arg.kb_status, cookie = _arg.cookie;
      opts = {
        method: method,
        json: true,
        jar: true
