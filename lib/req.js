...
(function() {
  var Client, E, PackageJson, certs, env, iced, k, log, m, proxyca, request, urlmod, __iced_k, __iced_k_noop, _cli, _fn,
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype.req = function(_arg, cb) {
      var args, body, ca, endpoint, err, http_status, jar, json, kb_status, method, opts, pathname, pcc, prx, res, search, tls, uri_fields, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/chris/git/keybase/node-client/src/req.iced",
            funcname: "Client.req"
          });
