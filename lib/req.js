...
(function() {
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype.set_proxy_ca_certs = function(c) {
      return this._proxy_ca_certs = c;
    };
    ...
    Client.prototype.req = function(_arg, cb) {
      var args, body, ca, endpoint, err, http_status, kb_status, method, opts, pcc, prx, res, tls, uri_fields, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      } else if ((opts.proxy != null) && ((pcc = this._proxy_ca_certs) != null)) {
