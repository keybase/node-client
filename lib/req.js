...
(function() {
  var Client, E, PackageJson, certs, env, iced, k, log, m, proxyca, request, tor, urlmod, __iced_k, __iced_k_noop, _cli, _fn,
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype.req = function(_arg, cb) {
      var args, body, ca, endpoint, err, http_status, jar, json, kb_status, method, opts, pathname, pcc, pjs, prx, res, search, tha, tls, tor_on, uri_fields, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      method = _arg.method, endpoint = _arg.endpoint, args = _arg.args, http_status = _arg.http_status, kb_status = _arg.kb_status, pathname = _arg.pathname, search = _arg.search, json = _arg.json, jar = _arg.jar;
      method || (method = 'GET');
      if (jar == null) {
        jar = true;
      }
