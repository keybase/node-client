...
(function() {
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype.req = function(_arg, cb) {
      var args, body, ca, endpoint, err, http_status, jar, json, kb_status, method, opts, pathname, pcc, pjs, prx, res, search, tls, uri_fields, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
