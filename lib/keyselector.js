...
(function() {
  var E, KeySelector, find_key_id_64, format, gpg, iced, load_key, log, log_10, make_esc, master_ring, pad, prompt_for_int, repeat, spc, tablify, __iced_k, __iced_k_noop, _ref;
  ...
  exports.KeySelector = KeySelector = (function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase/node-client/src/keyselector.iced",
    ...
    KeySelector.prototype.query_keys = function(cb) {
      var err, index, keys, opts, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      opts = {
        secret: this.secret,
      ...
      (function(_this) {
        ...
        return function() {
          keys = typeof err !== "undefined" && err !== null ? null : index.keys();
          return cb(err, keys);
        };
      })(this));
    };
    ...
    KeySelector.prototype.format_ts = function(t) {
      var d, s;
      d = new Date(t * 1000);
      return ((function() {
    ...
    KeySelector.prototype.key_to_array = function(key) {
      var args;
      args = [key._n_bits + (key._type === 1 ? 'R' : 'D'), key.key_id_64(), "exp: " + (this.format_ts(key._expires))].concat(key.emails());
      return args;
    };
    ...
    KeySelector.prototype.select_key = function(keys, cb) {
      var err, key, out, prompt, sel, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _len;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (this.query) {
