...
(function() {
  var BaseKeyRing, E, GpgKey, MasterKeyRing, TmpKeyRing, base64u, colgrep, constants, db, env, fs, gpg, iced, log, make_esc, master_ring, mkdirp, path, prng, strip, __iced_k, __iced_k_noop, _mring,
  ...
  colgrep = require('gpg-wrapper').colgrep;
  ...
  GpgKey = (function() {
    ...
    GpgKey.prototype.get_pgp_finterprint = function() {
    ...
    GpgKey.prototype.load = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      args = [(this._secret ? "--export-secret-key" : "--secret"), "--export-local-sigs", "-a", this.load_id()];
      log.debug("| Load key " + (this.to_string()) + " from " + (this.keyring.to_string()));
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
          ...
          _this.gpg({
            ...
            assign_fn: (function(__slot_1) {
              return function() {
                err = arguments[0];
                return __slot_1._key_data = arguments[1];
              };
            })(_this),
            lineno: 116
          }));
    ...
    GpgKey.prototype.read_uids_from_key = function(cb) {
      var args, err, read_uids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      args = {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.keyring.read_uids_from_keys(args, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return read_uids = arguments[1];
              };
            })(),
            lineno: 138
          }));
    ...
    GpgKey.prototype.rollback = function() {
    ...
    GpgKey.make_from_user = function(_arg) {
      var keyring, secret, user, _ref, _ref1;
      ...
      return new GpgKey({
        ...
        secret: false,
        uid: user.id,
        key_data: user != null ? (_ref = user.public_keys) != null ? (_ref1 = _ref.primary) != null ? _ref1.bundle : void 0 : void 0 : void 0,
        keyring: keyring
      });
    };
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            var _ref;
            _ref = _this._find_key_in_stderr(which, stderr.data()), err = _ref.err, ki64 = _ref.ki64, fingerprint = _ref.fingerprint;
            (function(__iced_k) {
              if (err) {
                return __iced_k();
              } else {
    ...
    GpgKey.prototype.is_temporary = function() {
      return true;
    };
  ...
  exports.MasterKeyRing = MasterKeyRing = (function(_super) {
    ...
    MasterKeyRing.prototype.is_temporary = function() {
      return false;
    };
  ...
  exports.TmpKeyRing = TmpKeyRing = (function(_super) {
    ...
    TmpKeyRing.prototype.mutate_args = function(gargs) {
      ...
      return log.debug("| Mutate GPG args; new args: " + (gargs.inargs.join(' ')));
    };

    TmpKeyRing.prototype.gpg = function(gargs, cb) {
