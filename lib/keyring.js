...
(function() {
  var BaseKeyRing, E, GPG, GpgKey, MasterKeyRing, TmpKeyRing, base64u, colgrep, constants, db, env, fs, gpg, iced, log, make_esc, master_ring, mkdirp, path, prng, strip, util, __iced_k, __iced_k_noop, _mring, _ref,
  ...
  _ref = require('gpg-wrapper'), GPG = _ref.GPG, colgrep = _ref.colgrep;
