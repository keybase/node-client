...
(function() {
  var BaseKeyRing, BufferOutStream, E, GE, GPG, GpgKey, MasterKeyRing, TmpKeyRing, athrow, base64u, colgrep, constants, db, env, fs, gpg, iced, log, make_esc, master_ring, mkdirp, path, prng, states, strip, util, __iced_k, __iced_k_noop, _mring, _ref, _ref1, _ref2,
          ...
          (function(__iced_k) {
            if (_this.fingerprint() == null) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k((rows.length === 0) || ((_this._fingerprint = rows[0][9]) == null) ? err = new GE.GpgError("Couldn't find GPG fingerprint for " + id) : (_this._state = state.LOADED, log.debug("- Map " + id + " -> " + _this._fingerprint + " via gpg")));
              });
            } else {
              return __iced_k();
            }
