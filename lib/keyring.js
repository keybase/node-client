...
(function() {
  var BaseKeyRing, BufferOutStream, E, GE, GPG, GpgKey, MasterKeyRing, TmpKeyRing, TmpKeyRingBase, TmpPrimaryKeyRing, athrow, base64u, colgrep, constants, db, env, fs, gpg, iced, log, make_esc, master_ring, mkdirp, path, prng, states, strip, util, __iced_k, __iced_k_noop, _mring, _ref, _ref1, _ref2,
  ...
  _ref2 = require('gpg-wrapper'), BufferOutStream = _ref2.BufferOutStream, GPG = _ref2.GPG, colgrep = _ref2.colgrep;
  ...
  GpgKey = (function() {
          ...
          (function(__iced_k) {
            if (_this.fingerprint() == null) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k((rows.length === 0) || ((_this._fingerprint = rows[0][9]) == null) ? err = new GE.GpgError("Couldn't find GPG fingerprint for " + id) : (_this._state = states.LOADED, log.debug("- Map " + id + " -> " + _this._fingerprint + " via gpg")));
              });
            } else {
              return __iced_k();
            }
    ...
    GpgKey.make_from_user = function(_arg) {
      var keyring, secret, user, _ref3, _ref4;
      ...
      return new GpgKey({
        ...
        uid: user.id,
        key_data: user != null ? (_ref3 = user.public_keys) != null ? (_ref4 = _ref3.primary) != null ? _ref4.bundle : void 0 : void 0 : void 0,
        keyring: keyring,
  ...
  TmpKeyRingBase = (function(_super) {
    ...
    TmpKeyRingBase.prototype.list = function(cb) {
