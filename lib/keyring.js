...
(function() {
  var BaseKeyRing, BufferOutStream, E, GPG, GpgKey, MasterKeyRing, TmpKeyRing, base64u, colgrep, constants, db, env, fs, gpg, iced, log, make_esc, master_ring, mkdirp, path, prng, strip, util, __iced_k, __iced_k_noop, _mring, _ref,
  ...
  _ref = require('gpg-wrapper'), BufferOutStream = _ref.BufferOutStream, GPG = _ref.GPG, colgrep = _ref.colgrep;
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (_this.keyring().is_temporary()) {
            ...
            return __iced_k(env().get_preserve_tmp_keyring() ? log.debug("| " + s + ": preserving temporary keyring by command-line flag") : log.debug("| " + s + ": no need to rollback key, it's permanent"));
          }
        });
      })(this)((function(_this) {
        return function() {
