...
(function() {
  ...
  exports.DecryptAndVerifyEngine = DecryptAndVerifyEngine = (function() {
              ...
              (function(__iced_k) {
                if (_this.username === env().get_username()) {
                  ...
                  (function(__iced_k) {
                    ...
                    tracks = remote ? "tracking remotely & locally" : local ? "tracking locally only" : "not tracking; consider `keybase track " + _this.username + "`";
    ...
    DecryptAndVerifyEngine.prototype.run = function(cb) {
      var dummy, esc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
                          ...
                          (function(__iced_k) {
                            if (_this.try_id()) {
                              (function(__iced_k) {
                                ...
                                _this.handle_id(__iced_deferrals.defer({
                                  assign_fn: (function() {
                                    return function() {
