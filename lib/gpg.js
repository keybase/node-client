...
(function() {
  ...
  TmpGPG = (function(_super) {
    ...
    TmpGPG.prototype.mutate_args = function(inargs) {
      ...
      return inargs.args = ["--keyring", env().get_tmp_gpg_pub_keyring(), "--secret-keyring", env().get_tmp_gpg_sec_keyring(), "--trustdb-name", env().get_tmp_gpg_trustdb(), "--no-default-keyring", "--no-random-seed-file"].concat(inargs.args);
    };
