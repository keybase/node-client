...
(function() {
  var E, Engine, gpg, iced, log, spawn, stream, __iced_k, __iced_k_noop;
  ...
  exports.gpg = gpg = function(_arg, cb) {
    var args, def_out, err, out, rc, stderr, stdin, stdout, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    args = _arg.args, stdin = _arg.stdin, stdout = _arg.stdout, stderr = _arg.stderr;
    if (stdin && Buffer.isBuffer(stdin)) {
    ...
    (function(__iced_k) {
      ...
      err = rc === 0 ? null : new E.GpgError("exit code " + rc);
