...
(function() {
  var E, KeyManager, KeyPull, PullTypes, User, chain_err, env, iced, log, make_esc, master_ring, prompt_yn, req, session, __iced_k, __iced_k_noop, _ref;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              err = null;
              pull_needed = !pub.remote ? (err = new E.NoRemoteKeyError("you don't have a public key; try `keybase push` if you have a key; or `keybase gen` if you need one"), PullTypes.ERROR) : pub.local && (!sec.remote || sec.local) && !_this.force ? PullTypes.NONE : sec.remote && (!sec.local || _this.force) ? PullTypes.SECRET : PullTypes.PUBLIC;
