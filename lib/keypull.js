...
(function() {
  var E, KeyManager, KeyPull, PullTypes, TmpKeyRing, User, chain_err, env, iced, log, make_esc, master_ring, prompt_yn, req, session, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.KeyPull = KeyPull = (function() {
    function KeyPull(_arg) {
      this.force = _arg.force, this.stdin_blocked = _arg.stdin_blocked;
    }

    KeyPull.prototype.secret_pull = function(cb) {
      var err, esc, km, p3skb, passphrase, prompter, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          if ((p3skb = _this.me.private_key_bundle()) == null) {
            ...
            (function(__iced_k) {
              if (_this.stdin_blocked) {
                return __iced_k(err = new E.NoLocalKeyError("Can't fetch your private key since you're performing a stream action; try an explicit `keybase pull`"));
              } else {
                err = null;
                passphrase = null;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              err = null;
              pull_needed = !pub.remote ? (err = new E.NoRemoteKeyError("you don't have a public key; try `keybase push` if you have a key; or `keybase gen` if you don't"), PullTypes.ERROR) : pub.local && (!sec.remote || sec.local) && !_this.force ? PullTypes.NONE : sec.remote && (!sec.local || _this.force) ? PullTypes.SECRET : PullTypes.PUBLIC;
    ...
    KeyPull.prototype.public_pull = function(cb) {
      var esc, n_proofs, tmp_keyring, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      tmp_keyring = null;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              _this.me.verify(esc(__iced_deferrals.defer({
                lineno: 101
              })));
              __iced_deferrals._fulfill();
            })(function() {
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    _this.me.key.commit({}, esc(__iced_deferrals.defer({
                      lineno: 104
                    })));
                    __iced_deferrals._fulfill();
                  })(function() {
    ...
    KeyPull.prototype.run = function(cb) {
      var esc, pull_type, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
