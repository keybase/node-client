...
(function() {
  var C, File, Tmp, base58, constants, crypto, fs, iced, log, mkdirp, open, path, strip_extension, tmp_filename, __iced_k, __iced_k_noop;
        ...
        if (!write) {
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              ...
              filename: "/home/max/src/keybase-node-client/src/fs.iced"
            });
        ...
        (function(__iced_k) {
          if (!found) {
            (function(__iced_k) {
              ...
              mkdirp(d, constants.permissions.dir, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    err = arguments[0];
