...
(function() {
  var SocksHttpAgent, SocksHttpsAgent, agent, enabled, env, hidden_address, log, proxy, strict;
  ...
  enabled = function() {
    return (env().get_tor() != null) || (proxy(true) != null) || (hidden_address(true) != null) || strict();
  };

  strict = function() {
    return env().get_tor_strict() && !env().get_tor_leaky();
  };
