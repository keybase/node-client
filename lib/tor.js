...
(function() {
  var SocksHttpAgent, SocksHttpsAgent, agent, enabled, env, hidden_address, log, paranoid, proxy;
  ...
  enabled = function() {
    return (env().get_tor() != null) || (proxy(true) != null) || (hidden_address(true) != null) || paranoid();
  };

  paranoid = function() {
    return env().get_tor_paranoid();
  };
