...
(function() {
  ...
  DB = (function() {
    ...
    DB.prototype.put = function(_arg, cb) {
      var args, esc, key, name, names, q, type, value, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    DB.prototype.remove = function(_arg, cb) {
      var e2, err, esc, key, q, type, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              _this.db.run(q, [type, key], __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
