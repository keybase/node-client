...
(function() {
  ...
  DB = (function() {
    ...
    DB.prototype._open = function(cb) {
      var db, err, esc, fn, key, val, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              if (name != null) {
                q = "REPLACE INTO lookup(name,name_type,key_type,key) VALUES(?,?,?,?)";
    ...
    DB.prototype.lookup = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          db.get(q, args, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return row = arguments[1];
