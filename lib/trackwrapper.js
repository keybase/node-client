...
(function() {
  var E, ST, TrackWrapper, colors, constants, db, deq, env, iced, log, make_esc, prompt_yn, proof_type_to_string, proofs, session, unix_time, util, __iced_k, __iced_k_noop;
  ...
  exports.TrackWrapper = TrackWrapper = (function() {
    ...
    TrackWrapper.remove_local = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase-node-client/src/trackwrapper.iced",
            funcname: "TrackWrapper.remove_local"
          });
          db.remove({
