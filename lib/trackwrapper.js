...
(function() {
  var E, Link, PT, ST, TrackWrapper, constants, db, deq, env, iced, log, make_esc, prompt_yn, proof_type_to_string, proofs, scrapers, session, unix_time, util, __iced_k, __iced_k_noop;
      ...
      prob = (function() {
        ...
        if (track_cert == null) {
          ...
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            ...
            if (((_ref2 = rkp.proof_type) === PT.generic_web_site || _ref2 === PT.dns)) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/chris/git/keybase/node-client/src/trackwrapper.iced",
