...
(function() {
  var ArgumentParser, Base, Command, KeybasePushProofGen, PackageJson, add_option_dict, env, iced, key_select, log, make_esc, prompt_for_int, req, session, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.push = function(cb) {
      ...
      args = {
        ...
        public_key: this.km.key_data().toString('utf8')
      };
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
