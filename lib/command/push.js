...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, PackageJson, add_option_dict, find_short_id, gpg, iced, log, log_10, make_esc, pad, prompt_for_int, repeat, session, spc, __iced_k, __iced_k_noop, _ref,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.query_keys = function(cb) {
      ...
      this.keys = null;
      args = ["-k"];
      if (this.search = this.argv.search) {
    ...
    Command.prototype.load_key = function(short_id, cb) {
      var err, esc, m, obj, raw, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/command/push.iced",
          funcname: "Command.load_key"
        });
        gpg({
          args: ["--export", "-a", short_id]
        }, esc(__iced_deferrals.defer({
          assign_fn: (function(__slot_1) {
            return function() {
              return __slot_1.full = arguments[0];
            };
          })(obj),
          lineno: 111
        })));
        ...
        (function(__iced_k) {
          ...
          if ((m = raw.toString().match(/Key fingerprint = ([A-F0-9 ]+)/)) != null) {
            ...
            obj.pgp_key_id = obj.fingerprint.slice(-16);
          } else {
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            _this.load_key(key.short_id, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return key = arguments[0];
                };
