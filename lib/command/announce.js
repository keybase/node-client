...
(function() {
  var ACCTYPES, ArgumentParser, Base, C, Command, CryptocurrencySigGen, E, GenericWebSiteProofGen, GithubProofGen, PackageJson, S, ST, TwitterProofGen, User, a_json_parse, add_option_dict, assert, bitcoyne, dict_union, drain, fs, iced, iutils, log, make_esc, prompt_remote_name, prompt_yn, proofs, req, session, stream_open, util, __iced_k, __iced_k_noop, _ref, _ref1,
