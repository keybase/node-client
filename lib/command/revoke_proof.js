...
(function() {
  ...
  exports.Command = Command = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/node-client/src/command/revoke_proof.iced",
    ...
    Command.prototype.get_the_go_ahead = function(cb) {
      var d, do_msg, e, err, n, names, ok, rp, service_name_display, to_prompt, v, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _j, _len, _len1;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      rp = this.me.list_remote_proofs({
        with_sig_ids: true
      });
      service_name_display = S.aliases_reverse[this.service_name];
      err = null;
      if ((rp == null) || ((v = rp[this.service_name]) == null)) {
        err = E.NotFoundError("No proof found for service '" + this.argv.service + "'");
        ...
        if (do_msg) {
          ...
          for (_j = 0, _len1 = names.length; _j < _len1; _j++) {
            n = names[_j];
            log.console.log("  keybase revoke-proof " + this.argv.service + " " + n);
          }
          log.console.log("");
        }
      } else {
        if ((this.remote_name != null) && (this.remote_name !== v.name)) {
          err = E.ArgsError("Wrong name provided: you have a proof for '" + v.name + "' and not '" + this.remote_name + "' @" + this.argv.service);
        } else if (this.remote_name != null) {
          this.sig_id = v.sig_id;
        } else {
          to_prompt = {
            prompt: "Revoke your proof of " + v.name + " at " + this.argv.service + "?",
            sig_id: v.sig_id
          };
        }
      }
