...
(function() {
  ...
  exports.Command = Command = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase-node-client/src/command/decrypt.iced",
    ...
    Command.prototype.make_gpg_args = function() {
      var args, gargs, o;
      args = ["--decrypt", "--with-colons", "--keyid-format", "long", "--keyserver", env().get_key_server(), "--keyserver-options", "auto-key-retrieve=1", "--with-fingerprint", "--yes"];
      if (env().get_debug()) {
