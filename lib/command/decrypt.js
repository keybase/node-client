...
(function() {
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.handle_signature = function(cb) {
      var a, arg, b, basics, err, esc, local, me, remote, them, tracks, trackw, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "handle_signature");
      arg = {
        type: constants.lookups.key_fingerprint_to_user,
        name: this.signing_key.primary
      };
      (function(_this) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    if (((a = _this.argv.signed_by) != null) && (a !== (b = _this.username))) {
                      return __iced_k(err = new E.WrongSignerError("Wrong signer: wanted '" + a + "' but got '" + b + "'"));
                    } else {
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                          parent: ___iced_passed_deferral,
                        ...
                        var _ref1;
                        _ref1 = trackw.is_tracking(), remote = _ref1.remote, local = _ref1.local;
