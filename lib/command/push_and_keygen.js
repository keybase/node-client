...
(function() {
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.check_no_key = function(cb) {
      var err, esc, exists, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.me.has_public_key(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  err = arguments[0];
            ...
            err = exists && !(_this.secret_only()) ? new E.KeyExistsError("You already have a key registered; you must revoke first") : !exists && _this.secret_only() ? new E.NoLocalKey("Can't push only a secret key without a public key") : null;
            return cb(err);
          });
        };
      })(this));
