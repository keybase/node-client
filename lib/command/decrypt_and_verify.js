...
(function() {
  var Base, BufferInStream, BufferOutStream, Command, E, TmpPrimaryKeyRing, TrackSubSubCommand, TrackWrapper, User, add_option_dict, athrow, chain, colors, constants, dict_union, env, iced, keypull, log, make_esc, parse_signature, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.do_command = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      this.decrypt_stderr = this.gargs.stderr;
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
          ...
          _this.tmp_keyring.gpg(_this.gargs, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
        ...
        return (function(__iced_k) {
          if (!_this.batch) {
            (function(__iced_k) {
              ...
              keypull({}, esc(__iced_deferrals.defer({
                lineno: 165
              })));
              __iced_deferrals._fulfill();
            })(__iced_k);
