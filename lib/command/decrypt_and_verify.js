...
(function() {
  var Base, BufferInStream, BufferOutStream, Command, E, HKPLoopback, TmpPrimaryKeyRing, TrackSubSubCommand, TrackWrapper, User, add_option_dict, athrow, chain, colors, constants, dict_union, env, fingerprint_to_key_id_64, iced, log, make_esc, parse_signature, timeago, urlmod, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.handle_signature = function(cb) {
      var a, arg, b, basics, d, date_signed, err, esc, iso_string, local, remote, time_ago, tracks, ts, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                if ((ts = _this.signing_key.timestamp) != null) {
                  d = new Date(ts);
                  if (isNaN(d.getTime())) {
    ...
    Command.prototype.do_output = function(o, cb) {
      return cb();
    };
