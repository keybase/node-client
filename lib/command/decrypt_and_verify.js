...
(function() {
  var Base, BufferInStream, BufferOutStream, Command, E, TmpPrimaryKeyRing, TrackSubSubCommand, TrackWrapper, User, add_option_dict, athrow, chain, colors, constants, dict_union, env, iced, log, mainca, make_esc, parse_signature, urlmod, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.make_gpg_args = function(cb) {
      var args, cafile, err, esc, gargs, ks, o, u, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Command::make_gpg_args");
      ks = env().get_key_server();
      args = ["--with-colons", "--keyid-format", "long", "--keyserver", ks, "--keyserver-options", "auto-key-retrieve=1", "--with-fingerprint"];
      if (env().get_debug()) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (!(((u = urlmod.parse(ks)) != null) && (ks.protocol === 'hkps:'))) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/Users/max/src/keybase/node-client/src/command/decrypt_and_verify.iced",
                funcname: "Command.make_gpg_args"
              });
              mainca.get_file(u.hostname, esc(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return cafile = arguments[0];
                  };
                })(),
                lineno: 151
              })));
              ...
              if (typeof cafile !== "undefined" && cafile !== null) {
                args.push("--keyserver-options", "ca-cert-file=" + cafile);
              }
              return __iced_k(args.push("--keyserver-options", "check-cert"));
            });
          } else {
            return __iced_k();
          }
        ...
        return function() {
          ...
          if (_this.argv.message) {
            gargs.stdin = new BufferInStream(_this.argv.message);
          } else if (_this.argv.file != null) {
            args.push(_this.argv.file);
          } else {
            gargs.stdin = process.stdin;
            _this.batch = true;
          }
          return cb(null, gargs);
        };
      })(this));
    };
    ...
    Command.prototype.do_command = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.make_gpg_args(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return gargs = arguments[1];
              };
            })(),
            lineno: 170
          }));
          ...
          (function(__iced_k) {
            if (typeof err === "undefined" || err === null) {
              ...
              (function(__iced_k) {
                ...
                _this.do_output(out);
                return __iced_k(typeof err !== "undefined" && err !== null ? log.warn(_this.decrypt_stderr.data().toString('utf8')) : env().get_debug() ? log.debug(_this.decrypt_stderr.data().toString('utf8')) : void 0);
              });
            } else {
              return __iced_k();
            }
