...
(function() {
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.run = function(cb) {
      var esc, logged_in, me, un, ___iced_passed_deferral, __iced_deferrals, __iced_k;
          ...
          if ((un = env().get_username()) != null) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k(typeof me !== "undefined" && me !== null ? (log.console.log("  * Key ID: " + (me.key_id_64().toUpperCase())), log.console.log("  * Fingerprint: " + (format_fingerprint(me.fingerprint(true))))) : void 0);
              });
            });
          } else {
            return __iced_k(log.error("Not configured"));
          }
        });
      })(this)((function(_this) {
        return function() {
