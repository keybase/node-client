...
(function() {
  var ArgumentParser, Base, Command, add_option_dict, env, iced, log, make_esc, path, rewrite, run, version_info, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.probe_installer = function(cb) {
      var err, vers, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          ...
          run({
            name: 'keybase-installer',
            args: ["--version"]
          }, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return vers = arguments[1];
              };
            })(),
            lineno: 72
          }));
      ...
      (function(_this) {
        ...
        return function() {
          if (typeof err !== "undefined" && err !== null) {
            ...
            _this.npm_install_prefix = ret.toString('utf8');
    ...
    Command.prototype.compute_prefix = function(cb) {
      ...
      } else if (((implicit_path = this.my_bindir.split(path.sep)).pop() === 'bin') && !(path_eq(this.npm_install_prefix.split(path.sep), implicit_path))) {
        this.prefix = path.join.apply(path, implicit_path);
    ...
    Command.prototype.run_install = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.npm(args, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return out = arguments[1];
