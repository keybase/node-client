...
(function() {
  var Base, BufferInStream, Command, E, TrackSubSubCommand, User, add_option_dict, codesign, fs, gpg, iced, keypull, log, make_esc, master_ring, path, __iced_k, __iced_k_noop,
    ...
    Command.prototype.verify = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.target_file_to_json(_this.argv.input, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this.target_file_to_json(_this.argv.output, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        old_err = arguments[0];
                    ...
                    if (typeof old_obj !== "undefined" && old_obj !== null) {
                      (function(__iced_k) {
                        ...
                        if (!probs.length) {
                          ...
                          if (!_this.argv.quiet) {
                            log.info("Will replace existing/obsolete " + _this.argv.output);
                          }
                        }
                        return __iced_k();
                      });
