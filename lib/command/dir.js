...
(function() {
  var Base, BufferInStream, Command, E, MyEngine, TrackSubSubCommand, User, add_option_dict, chain, codesign, fs, gpg, iced, keypull, log, make_esc, master_ring, path, write_tmp_file, __iced_k, __iced_k_noop, _ref,
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              run(esc(__iced_deferrals.defer({
                lineno: 58
              })));
              __iced_deferrals._fulfill();
            })(function() {
