...
(function() {
  var ArgumentParser, Base, Command, E, GithubProofGen, PackageJson, TwitterProofGen, User, add_option_dict, iced, log, make_esc, prompt_remote_username, prompt_yn, req, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.handle_post = function(cb) {
      var err, esc, first, found, line, lines, prompt, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _len;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      log.console.log("Please " + (this.gen.imperative_verb()) + " the following:");
      log.console.log("");
      lines = this.gen.proof_text.split("\n");
