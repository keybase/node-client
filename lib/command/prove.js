...
(function() {
  var ArgumentParser, Base, Command, E, GithubProofGen, PackageJson, S, TwitterProofGen, User, add_option_dict, assert, iced, log, make_esc, prompt_remote_username, prompt_yn, req, session, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.allocate_proof_gen = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      klass = S.table[this.service_name];
