...
(function() {
  var ArgumentParser, Command, E, GenericWebSiteProofGen, GithubProofGen, PackageJson, ProofBase, S, TwitterProofGen, User, add_option_dict, assert, dict_union, fs, iced, log, make_esc, prompt_remote_name, prompt_yn, req, session, util, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.handle_post = function(cb) {
      var err, esc, f, fail, first, found, i, prompt, retry, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return (function(__iced_k) {
          if ((f = _this.argv.output) != null) {
            ...
            (function(__iced_k) {
              ...
              fs.writeFile(f, _this.gen.proof_text, esc(__iced_deferrals.defer({
                lineno: 107
              })));
              __iced_deferrals._fulfill();
            })(function() {
            ...
            return __iced_k(log.console.log(_this.gen.proof_text));
          }
        });
      })(this)((function(_this) {
        return function() {
                  ...
                  (function(__iced_k) {
                    if (prompt) {
                      (function(__iced_k) {
                        ...
                        i++;
                        prompt = !found;
                        return __iced_k(found ? (fail = false, log.info("Success!")) : (retry = _this.gen.do_recheck(i), retry ? log.warn("Didn't find the posted proof.") : (prompt = false, fail = false)));
                      });
                    } else {
                      return __iced_k();
                    }
