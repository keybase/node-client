...
(function() {
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.check_exists_2 = function(cb) {
      ...
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      console.log(this.rp[this.service_name]);
      (function(_this) {
        return (function(__iced_k) {
          var _ref2;
          if (!(_this.stub.single_occupancy()) && ((v = _this.rp[_this.service_name]) != null) && (_ref2 = _this.remote_name_normalized, __indexOf.call(v, _ref2) >= 0)) {
