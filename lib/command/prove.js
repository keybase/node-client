...
(function() {
  var ArgumentParser, Base, Command, E, GenericWebSiteProofGen, GithubProofGen, PackageJson, TwitterProofGen, User, add_option_dict, assert, iced, log, make_esc, prompt_remote_name, prompt_yn, req, session, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.prompt_remote_name = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if ((ret = _this.argv.remote_name) == null) {
            (function(__iced_k) {
        ...
        return function() {
          _this.remote_name = ret;
          _this.remote_name_normalized = _this.stub.normalize_name(ret);
          return cb(err, ret);
        };
      })(this));
    };
    ...
    Command.prototype.check_exists_1 = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if ((typeof rp !== "undefined" && rp !== null) && (v = _this.rp[_this.service_name]) && _this.stub.single_occupancy()) {
    ...
    Command.prototype.check_exists_2 = function(cb) {
      var err, prompt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      (function(_this) {
        return (function(__iced_k) {
          var _ref2;
          if (!(_this.stub.single_occupancy()) && (_ref2 = _this.remote_name_normalized, __indexOf.call(_this.rp[_this.service_name], _ref2) >= 0)) {
            prompt = "You already have proved ownership of " + _this.remote_name + "; overwrite? ";
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-client/src/command/prove.iced",
