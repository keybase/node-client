...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype._write_session = function(cb) {
      ...
      s = env().session;
      (function(__iced_k) {
        if ((s = _this.session || req.cookies().session) != null) {
          s.set("session", s);
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
              filename: "src/command/base.iced",
              funcname: "Base._write_session"
            });
            s.write(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
          ...
          return __iced_k(err = new E.InternalError("no session ID but expected one"));
        }
      })(function() {
        return cb(err);
      });
