...
(function() {
  var Base, E, EscOk, FN, Infile, Outfile, PasswordManager, SRV, add_option_dict, base58, constants, crypto, fs, iced, join, log, myfs, pick, rmkey, __iced_k, __iced_k_noop, _ref,
    __slice = [].slice;
