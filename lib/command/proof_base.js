...
(function() {
  ...
  exports.ProofBase = Command = (function(_super) {
    ...
    Command.prototype.add_subcommand_parser = function(scp) {
      var OPTS, config, name, sub, _ref2;
      _ref2 = this.command_name_and_opts(), name = _ref2.name, config = _ref2.config, OPTS = _ref2.OPTS;
      sub = scp.addParser(name, config);
      add_option_dict(sub, OPTS);
      sub.addArgument(["service"], {
        nargs: 1,
        help: "the name of service; can be one of: {twitter,github,web}"
      });
          ...
          if (_this.remote_name == null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/max/src/keybase/node-client/src/command/proof_base.iced",
