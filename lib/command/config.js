...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, add_option_dict, convert, env, gpg, iced, log, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.run = function(cb) {
      ...
      if ((k = this.argv.get) != null) {
        ...
        k = this.argv.kvs[0];
        v = convert(this.argv.kvs.length === 2 ? this.argv.kvs[1] : null);
        c.set(k, v);
      } else if (c.is_empty()) {
        pjs = new PackageJson();
        c.set("generated", {
