          ...
          if ((k = _this.argv.get) != null) {
            ...
            (function(__iced_k) {
              if ((s = _this.argv.server) != null) {
                return __iced_k((url = urlmod.parse(s)) != null ? (url.protocol === "http:" ? c.set("server.no_tls", true) : void 0, (p = url.port) != null ? c.set("server.port", parseInt(p, 10)) : void 0, (h = url.hostname) != null ? c.set("server.hostname", h) : void 0) : (msg = "Couldn't parse server URL " + url, log.error(msg), err = new E.ArgsError(msg)));
              } else {
                (function(__iced_k) {
