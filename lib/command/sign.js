...
(function() {
  var Base, BufferInStream, Command, E, TrackSubSubCommand, User, add_option_dict, gpg, iced, log, make_esc, __iced_k, __iced_k_noop,
    ...
    Command.prototype.load_me = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          User.load_me(__iced_deferrals.defer({
