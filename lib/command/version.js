...
(function() {
  var ArgumentParser, Base, Command, PackageJson, TempKeyRing, add_option_dict, gpg, iced, log, __iced_k, __iced_k_noop,
  ...
  TempKeyRing = require('../keyring').TempKeyRing;
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.run = function(cb) {
      var dat, dir, err, gpg_v, l, lines, pjs, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            TempKeyRing.make(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  err = arguments[0];
            ...
            (function(__iced_k) {
              ...
              dir.nuke(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
