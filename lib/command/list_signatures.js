...
(function() {
  var Base, Command, E, ST, User, add_option_dict, constants, env, format_fingerprint, iced, log, make_esc, session, tablify, timeago, util, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.display_text = function(list) {
      var ctime, id, live, payload, rows, seqno, type;
      rows = (function() {
        var _i, _len, _ref, _results;
        _results = [];
        for (_i = 0, _len = list.length; _i < _len; _i++) {
          _ref = list[_i], seqno = _ref.seqno, id = _ref.id, type = _ref.type, ctime = _ref.ctime, live = _ref.live, payload = _ref.payload;
          _results.push([seqno, id.slice(0, 9) + "...", type, timeago(new Date(ctime * 1000)), (live ? "+" : "-"), (typeof payload === 'string' ? payload : JSON.stringify(payload))]);
        }
        return _results;
      })();
      return tablify(rows, {
