...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, ProxyCACerts, add_option_dict, db, env, gpgw, iced, init_env, keyring, log, make_esc, platform_info, req, run, session, version_info, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  ProxyCACerts = require('../proxyca').ProxyCACerts;
  ...
  Main = (function() {
          ...
          if (_this.cmd.use_config()) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/max/src/keybase/node-client/src/command/all.iced",
    ...
    Main.prototype.init_proxy_cas = function(cb) {
      var cas, err, found, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          cas.load(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
        ...
        return function() {
          if (!(typeof err !== "undefined" && err !== null) && found) {
            ...
            _this.cmd.set_proxy_ca_certs(cas);
          }
          return cb(err);
        };
      })(this));
