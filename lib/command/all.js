...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, SubParserWrapper, add_option_dict, db, env, gpgw, iced, init_env, keyring, log, make_esc, platform_info, proxyca, req, run, session, version_info, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice;
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["cert", "config", "decrypt", "encrypt", "help", "id", "join", "keygen", "list_tracking", "login", "logout", "pull", "push", "prove", "reset", "revoke", "revoke_proof", "search", "sign", "status", "switch", "track", "untrack", "verify", "version"];
