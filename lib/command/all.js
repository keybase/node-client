...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["cert", "dir", "config", "decrypt", "encrypt", "help", "id", "join", "keygen", "list_tracking", "login", "logout", "pull", "push", "prove", "reset", "revoke", "revoke_proof", "search", "sign", "status", "switch", "track", "untrack", "update", "verify", "version"];
