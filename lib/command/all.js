...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, SubParserWrapper, add_option_dict, db, env, gpgw, iced, init_env, keyring, log, make_esc, platform_info, proxyca, req, run, session, tor, version_info, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice;
