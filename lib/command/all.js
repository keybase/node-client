...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["cert", "config", "decrypt", "encrypt", "help", "id", "join", "keygen", "list-trackees", "login", "logout", "pull", "push", "prove", "reset", "revoke", "sign", "status", "switch", "track", "untrack", "verify", "version"];
