...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, add_option_dict, db, env, gpgw, iced, init_env, keyring, log, make_esc, platform_info, req, run, session, version_info, __iced_k, __iced_k_noop, _ref, _ref1;
