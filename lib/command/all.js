...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["cert", "config", "decrypt", "email", "encrypt", "help", "id", "join", "keygen", "list_tracking", "login", "logout", "pull", "push", "prove", "reset", "revoke", "search", "sign", "status", "switch", "track", "untrack", "verify", "version"];
