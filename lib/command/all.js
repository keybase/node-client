...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["cert", "codesign", "config", "decrypt", "encrypt", "help", "id", "join", "keygen", "list_tracking", "login", "logout", "pull", "push", "prove", "reset", "revoke", "revoke_proof", "search", "sign", "status", "switch", "track", "untrack", "update", "verify", "version"];
          ...
          if (_this.cmd.use_config()) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/chris/git/keybase/node-client/src/command/all.iced",
