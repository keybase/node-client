...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, add_option_dict, db, env, gpg, iced, init_env, keyring, log, make_esc, req, run, session, __iced_k, __iced_k_noop, _ref;
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["config", "decrypt", "encrypt", "help", "join", "id", "login", "logout", "push", "prove", "reset", "revoke", "sign", "status", "switch", "track", "untrack", "verify", "version"];
