...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, SubParserWrapper, add_option_dict, check_node_async, colors, db, env, gpgw, iced, init_env, keyring, log, make_esc, platform_info, proxyca, req, run, session, tor, version_info, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice;
        ...
        return (function(__iced_k) {
          if (_this.cmd.use_gpg()) {
            ...
            (function(__iced_k) {
              ...
              return __iced_k(log.debug("- tested GPG command-line client -> " + err));
            });
          } else {
            return __iced_k();
          }
