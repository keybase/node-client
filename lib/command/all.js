...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, add_option_dict, clean_key_imports, db, env, iced, init_env, log, make_esc, req, run, session, __iced_k, __iced_k_noop, _ref;
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["config", "help", "join", "login", "logout", "push", "prove", "reset", "revoke", "switch", "track", "untrack", "version"];
