...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, add_option_dict, env, iced, init_env, log, make_esc, req, run, __iced_k, __iced_k_noop, _ref;
    ...
    Main.prototype.load_session = function(cb) {
      ...
      (function(__iced_k) {
        if (_this.cmd.use_session()) {
          _this.session = new Config(env().get_session_filename(), {
            quiet: true
          });
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            _this.session.open(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return err = arguments[0];
                };
            ...
            var _ref1;
            return __iced_k((err == null) && _this.session.found && ((s = (_ref1 = _this.session.obj()) != null ? _ref1.session : void 0) != null) ? req.set_session(s) : void 0);
          });
        } else {
          return __iced_k();
        }
