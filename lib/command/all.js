...
(function() {
  var ArgumentParser, Base, Config, E, Main, PackageJson, add_option_dict, clean_key_imports, db, env, gpg, iced, init_env, log, make_esc, req, run, session, __iced_k, __iced_k_noop, _ref;
  ...
  clean_key_imports = require('../keyring').clean_key_imports;
  ...
  Main = (function() {
    ...
    Main.prototype.add_subcommands = function() {
      ...
      list = ["config", "help", "join", "id", "login", "logout", "push", "prove", "reset", "revoke", "switch", "track", "untrack", "version"];
          ...
          if (_this.cmd.use_db()) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase-node-client/src/command/all.iced",
                funcname: "Main.cleanup_previous_crash"
              });
              clean_key_imports(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
