...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, TrackWrapper, User, add_option_dict, colors, constants, db, env, gpg, iced, log, make_esc, prompt_yn, proofs, session, util, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase-node-client/src/command/track.iced",
    ...
    Command.prototype.prompt_track = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (_this.argv.remote) {
            return __iced_k(ret = true);
          } else {
            (function(__iced_k) {
              if (_this.argv.batch || _this.argv.local) {
