...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, Prompter, SC, add_option_dict, checkers, constants, env, gpg, iced, log, make_esc, prompt_yn, read, req, rng, session, triplesec, __iced_k, __iced_k_noop, _ref,
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase-node-client/src/command/join.iced",
