...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, Track, User, add_option_dict, colors, db, env, gpg, iced, log, make_esc, prompt_yn, proofs, util, __iced_k, __iced_k_noop, _ref,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.track = function(_arg, cb) {
      var do_remote, err, tobj, trackee, tracker, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
