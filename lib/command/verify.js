...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, Track, User, add_option_dict, colors, constants, db, env, gpg, iced, log, make_esc, prompt_yn, proofs, session, util, __iced_k, __iced_k_noop, _ref,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.track = function(_arg, cb) {
      var do_remote, esc, tobj, trackee, tracker, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      tracker = _arg.tracker, trackee = _arg.trackee, do_remote = _arg.do_remote;
      esc = make_esc(cb, "Verify::track");
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/command/verify.iced",
          funcname: "Command.track"
        });
    ...
    Command.prototype._run2 = function(_arg, cb) {
      var accept, approve, check, do_remote, err, esc, me, n_warnings, them, track, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            if ((check = track.skip_remote_check()) === constants.skip.NONE) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k(n_warnings = warnings.warnings.length());
              });
            } else {
              log.info("...skipping remote checks");
              return __iced_k(n_warnings = 0);
            }
          })(function() {
            (function(__iced_k) {
              if ((approve = track.skip_approval()) !== constants.skip.NONE) {
