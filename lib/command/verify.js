...
(function() {
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.track = function(_arg, cb) {
      var do_remote, esc, tobj, trackee, tracker, trackw, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      tracker = _arg.tracker, trackee = _arg.trackee, trackw = _arg.trackw, do_remote = _arg.do_remote;
        ...
        (function(__iced_k) {
          if (do_remote) {
            ...
            (function(__iced_k) {
              ...
              trackw.store_local(tobj, esc(__iced_deferrals.defer({
                lineno: 109
              })));
              __iced_deferrals._fulfill();
            })(__iced_k);
