...
(function() {
  var ArgumentParser, Base, BufferOutStream, Command, E, PackageJson, Track, User, add_option_dict, colors, db, env, gpg, iced, log, make_esc, prompt_yn, proofs, session, util, __iced_k, __iced_k_noop, _ref,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype._run2 = function(_arg, cb) {
      var accept, do_remote, err, esc, me, n_warnings, them, track, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
