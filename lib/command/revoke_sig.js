...
(function() {
  ...
  exports.Command = Command = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/node-client/src/command/revoke_sig.iced",
    ...
    Command.prototype.find_sig = function(cb) {
      ...
      key = this.argv.sig[0];
      if (this.argv.seqno) {
        sig = this.me.sig_chain.seq[key];
      } else {
        _ref = this.find_sig_by_prefix(key), err = _ref[0], sig = _ref[1];
      }
