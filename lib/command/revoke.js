...
(function() {
  var ArgumentParser, Base, Command, E, PackageJson, User, add_option_dict, bold, constants, env, format_fingerprint, gpg, iced, log, make_esc, prompt_yn, req, session, __iced_k, __iced_k_noop,
  ...
  exports.Command = Command = (function(_super) {
    ...
    Command.prototype.show_key = function(cb) {
      var err_public, err_secret, esc, fp, me, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              log.warn("  - Secret key: " + (typeof err_secret !== "undefined" && err_secret !== null ? 'unfound' : bold('found')));
              return cb();
            });
          });
        };
